...
<?php
    ...
    <div class="container">
        <div class="card card-container" style="padding: 5px 40px;background-color:#ffffff;">	
            <img id="profile-img" class="profile-img-card" src="<?php echo $this->config->item('base_url2')?>images/nomads/logo.jpg" />			
            <p id="profile-name" class="profile-name-card" style="font-size:20px;text-align:left;margin-bottom: 10px;">Welcome Back <?php if((isset($_REQUEST['Member_login'])) || ($Member_flag==1)){ ?><?php } else { ?> Business<?php } ?> </p>	
			<p style="color: #003254;font-size:12px;">Sign with your user email address and password</p>			
			<?php 
			...
			<?php echo form_close(); ?>
			<p>Are you a Member? <a href="#lost" data-dismiss="modal" data-toggle="modal" data-target="#myModal3" style="color:#003254;text-decoration: underline;">Sign up</a>
			</p>
				...
				<div class="modal-content">
					...
					<div class="modal-body modal-body-sub_agile">
						<div class="col-md-12 modal_body_left modal_body_left1">
							 <img id="profile-img" class="profile-img-card" src="<?php echo $this->config->item('base_url2')?>images/nomads/logo.jpg" style="width:40%"/>	
...
<!-- //Modal3 -->
		...
		<a href="#myModal14" data-toggle="modal" data-target="#myModal14" class="forgot-password success" style="color:#003254;">Forgot password?</a>		
		...
		<div id="myModal14" class="modal fade" role="dialog" >
					<div class="modal-dialog">
						...
						<div class="modal-content">
						  ...
						  <div class="modal-header">
							<h4 class="modal-title" style="color:#003254;text-align:center">Forgot Password</h4>
						  </div>
...
body {
 ...
 background-image: url("<?php echo $this->config->item('base_url2')?>images/nomads/background_image.jpg"); 
	<?php }else{ ?>
 background-image: url("<?php echo $this->config->item('base_url2')?>images/nomads/background_image.jpg"); 
 <?php } ?>
