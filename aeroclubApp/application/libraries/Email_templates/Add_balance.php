    ...
    <div class="BoxHldr" style="position: relative;background-color: #fff;height: auto;border-radius: 50px 50px 0px 0px;margin-top: -60px;padding-top: 50px;">
        <div style="width: 100%;padding-right: 15px;padding-left: 15px;">
            <div style="position: relative;margin: 0;padding: 0 10px;">
                <h2 style="font-size: 20px;padding-bottom: 15px;font-family: 'Poppins', sans-serif;margin: 0;color: #2F296D;font-weight: 700;">Dear $Customer_name,</h2>
                ...
                <ul style="position: relative;margin: 0;padding: 0;color: #000;list-style:none;">
                    ...
                    <li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;"><span style="font-family: 'Poppins', sans-serif;margin-right: 8px;font-weight: 600;">Order No:</span> $Bill_no</li>
                    <li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;"><span style="font-family: 'Poppins', sans-serif;margin-right: 8px;font-weight: 600;">Amount:</span> $Symbol_currency $Paid_amount</li>
