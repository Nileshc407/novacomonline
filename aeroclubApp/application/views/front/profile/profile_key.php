                ...
                <div class="col-12">
					<form class="perDetailForm" id="Updateprofile" method="post" action="<?php echo base_url();?>index.php/Cust_home/profile">
						...
						<div id="BirthDate" class="group w-100 mt-5">
                            <input type="text" name="dob" id="datepicker1" <?php if($Enroll_details->Date_of_birth != Null && $Enroll_details->Date_of_birth != "1970-01-01 00:00:00" && $Enroll_details->Date_of_birth != "0000-00-00 00:00:00") { ?> disabled value="<?php echo date('Y-m-d', strtotime($Enroll_details->Date_of_birth)); ?>" <?php } ?> required>
                            <span class="bar"></span>
                            <label class="w-100 pb-3" style="top:-16px;">Date of Birth</label>
                        </div>
						...
						<input type="hidden" name="dob" value="<?php echo date('Y-m-d', strtotime($Enroll_details->Date_of_birth)); ?>">
						<?php } ?>
						<div class="group w-100 mt-5">
