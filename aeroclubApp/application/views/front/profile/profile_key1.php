...
<main class="padTop perDetailsWrapper">
    ...
    <div class="BoxHldr">
        <div class="container">
			...
			?>
                <div class="col-12">
					<form class="perDetailForm" id="Updateprofile" method="post" action="<?php echo base_url();?>index.php/Cust_home/profile1">
                        ...
                        <div class="group w-100 mt-5">
                            <input type="text" name="middleName" id="middleName" value="<?php echo ucwords($Enroll_details->Middle_name); ?>" onblur="allLetter1(this.value);" required>
                            <span class="bar"></span>
						...
						<div class="group w-100 mt-5">
                            <input type="text" name="City" id="City" value="<?php echo $Enroll_details->City; ?>" required>
                            <span class="bar"></span>
                            <label>City</label>
                        </div>
						<div class="group w-100 mt-5">
                            <input type="text" name="State" id="State" value="<?php echo $Enroll_details->State; ?>" required>
                            <span class="bar"></span>
                            <label>State</label>
                        </div>
						<div class="group w-100 mt-5">
                            <input type="text" name="Zip" id="Zip" value="<?php echo $Enroll_details->Zipcode; ?>" required>
                            <span class="bar"></span>
						...
						<div class="group w-100 mt-5">
						 ...
						 <div class="group w-100 mt-5">
                            <input type="text"  name="homeEmailId" id="homeEmailId" value="<?php  if($Enroll_details->User_email_id1 != Null){ echo App_string_decrypt($Enroll_details->User_email_id1); } ?>" onblur="checkemail1();" required>
                            <span class="bar"></span>
						...
						<div class="group w-100 mt-5">
                            <input type="number" name="phno1" id="phone1" value="<?php if($Enroll_details->Phone_no1 != Null){ echo  App_string_decrypt($Enroll_details->Phone_no1); } ?>" required>
                            <span class="bar"></span>
                            <label class="w-100 pb-3" style="top:-16px;">Mobile Number 2</label>
						...
						<div class="group w-100 mt-5">
                            <input type="text" name="Occupation" id="Occupation" value="<?php echo $Enroll_details->Occupation; ?>" required>
                            <span class="bar"></span>
                            <label>Occupation</label>
                        </div>
						<div class="group w-100 mt-5">
                            <input type="text" name="Employer" id="Employer" value="<?php echo $Enroll_details->Employer; ?>" required>
                            <span class="bar"></span>
                            <label>Employer</label>
                        </div>
						<div class="group w-100 mt-5">
                            <input type="text" name="Blood_group" id="Blood_group" value="<?php echo $Enroll_details->Blood_group; ?>" required>
                            <span class="bar"></span>
						...
						<div class="form-group mt-4">
                            <label class="w-100 pb-2">Martial Status</label>
                            <label class="radioBtnMain mr-4">Married
								<input type="radio" <?php if($Enroll_details->Married=='Married') { echo "checked"; } ?> name="Marital_status" value="Married">
                                <span class="checkmark"></span>
                            </label>
                            <label class="radioBtnMain mr-4">Single
                                <input type="radio" <?php if($Enroll_details->Married=='Single') { echo "checked"; } ?> name="Marital_status" value="Single">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                       
					   <div id="AnniversaryDate" class="group w-100 mt-5">
                            <input type="text" name="Wedding_annversary_date" id="datepicker1" value="<?php echo date('Y-m-d', strtotime($Enroll_details->Wedding_annversary_date)); ?>">
                            <span class="bar"></span>
...
{		
	...
	var validEmailId=ValidateEmail(homeEmailId);
