	...
	<div class="container">
		<div class="row">
			<div class="col-12 d-flex justify-content-between align-items-center hedMain">
				<div class="leftRight"><button onclick="location.href = '<?php echo base_url();?>index.php/Cust_home/profile';"><img src="<?php echo base_url(); ?>assets/img/back-icon.svg"></button></div>
				<div><h1>Verify Email</h1></div>
				...
				<div class="col-12">
					<?php echo form_open_multipart('Cust_home/Verified_email'); ?>
								 ...
								 <div class="group w-100">
									<input type="text" name="userEmailId" id="userEmailId" value="<?php echo $User_email_id; ?>" required>
									<span class="bar"></span>
