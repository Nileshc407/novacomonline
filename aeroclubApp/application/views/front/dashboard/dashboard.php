		...
		<div class="row">
			<div class="col-12 accountBalanceWrapper">
				<div class="CurrBalance">
					...
					<?php } else { ?>
					<a href="#" class="RedeemBtn text-center"> <img class="mr-2" src="<?php echo base_url(); ?>assets/img/qrcode-scan-icon.svg"> Pay</a>
					<br><br>
					<a href="#" class="RedeemBtn text-center"> Add Balance</a>
					
					<br><br>
					<span id="card_check" style="color:red">You have not been asisgned Membership yet</span>
					<?php } ?>
				</div>
