		...
		<div class="row">
			...
			<div class="col-12 contactWrapper">
                <div class="row">
                    <div class="col-6 pr-2">
                        <a class="cf w-100" href="tel:254 719 547940<?php //echo $Phone_no;  ?>">
                    ...
                    <div class="col-6 pl-2">
                        <a class="cf w-100" href="mailto:Guest.relations@javahouseafrica.com<?php //echo $User_email_id;  ?>">
                            <div class="cardMain text-center">
            ...
            <div class="col-12 contactWrapper">
                <div class="cardMain mb-4 p-3">
                    <p><i class="mr-2"><img src="<?php echo base_url(); ?>assets/img/phone-icon.svg"></i> +254 719 547940<?php /* echo substr($Phone_no, 0, 3).' '.substr($Phone_no, 3, 2).' '.substr($Phone_no,5,2).' '.substr($Phone_no,7,2).' '.substr($Phone_no,9,2);  */ ?></p>
                    <p><i class="mr-2"><img src="<?php echo base_url(); ?>assets/img/phone-icon.svg"></i> +254 769 512444<?php /* echo substr($Phone_no, 0, 3).' '.substr($Phone_no, 3, 2).' '.substr($Phone_no,5,2).' '.substr($Phone_no,7,2).' '.substr($Phone_no,9,2);  */ ?></p>
                    <p><i class="mr-2"><img src="<?php echo base_url(); ?>assets/img/email-icon.svg"></i>Guest.relations@javahouseafrica.com<?php /* echo $User_email_id; */  ?></p>
                </div>
				<?php
