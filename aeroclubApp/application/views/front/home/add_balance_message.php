	...
	<div class="container">
		<div class="row">
			<div class="col-12 d-flex justify-content-between align-items-center hedMain">
				<div class="leftRight"><button onclick="location.href = '<?php echo base_url();?>index.php/Cust_home/AddBalance';"><img src="<?php echo base_url(); ?>assets/img/back-icon.svg"></button></div>
    ...
    <div class="BoxHldr" style="position: relative;background-color: #fff;height: auto;border-radius: 50px 50px 0px 0px;margin-top: -60px;padding-top: 50px;">
        <div style="width: 100%;padding-right: 15px;padding-left: 15px;">
            <div style="position: relative;margin: 0;padding: 0 10px;">
                <h2 style="font-size: 20px;padding-bottom: 15px;font-family: 'Poppins', sans-serif;margin: 0;color: #2F296D;font-weight: 700;"><?php if($Msg_code == '0000') {  echo "Thanks for your Balance Added!";  } else { echo "Payment not Received..Try Again!"; } ?></h2>
				<?php if($Msg_code == '0000') { ?>
					...
					<p><span class="value">Current Balance :</span> <?php echo $Current_balance; ?> </p>
				<?php } ?>
            </div>
