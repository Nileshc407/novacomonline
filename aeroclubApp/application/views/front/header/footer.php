 <?php 
		...
		if($fetch_method=='more' || $fetch_method=='terms_conditions' || $fetch_method=='privacy_policy'){
...
<footer>
	<ul class="iconMenu d-flex align-items-center">
		...
		<li>
			<a class="more <?php echo $noticss; ?>" href="<?php echo base_url(); ?>index.php/Cust_home/mailbox">
