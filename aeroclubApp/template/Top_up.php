        ...
        <div style="width: 100%;padding-right: 15px;padding-left: 15px;">
            <div style="position: relative;margin: 0;padding: 0 10px;">
                ...
                <ul style="position: relative;margin: 0;padding: 0;color: #000;list-style:none;">
					...
					<li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;"><span style="font-family: 'Poppins', sans-serif;margin-right: 8px;font-weight: 600;">New $Comapany_Currency balance:</span> $Current_balance</li>
