   ...
   <div class="BoxHldr" style="position: relative;background-color: #fff;height: auto;border-radius: 50px 50px 0px 0px;margin-top: -60px;padding-top: 50px;">
        <div style="width: 100%;padding-right: 15px;padding-left: 15px;">
            <div style="position: relative;margin: 0;padding: 0 10px;">
                ...
                <!--<div style="font-size: 14px;padding-bottom: 15px;color: #999999;">$Description</div>-->
                <ul style="position: relative;margin: 0;padding: 0;color: #000;list-style:none;">
                    <li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;">$Description</li>
                    <li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;color: #2F296D;font-weight: bold;">Voucher Code : $Voucher_no</li>
					...
					<li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;">We look forward to your next visit.</li>
					<li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;">Thank you</li>
					<li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;">*Terms and Conditions Apply</li>
                </ul>
            </div>
        </div>
    </div>
