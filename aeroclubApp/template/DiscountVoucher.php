        ...
        <div style="width: 100%;padding-right: 15px;padding-left: 15px;">
            <div style="position: relative;margin: 0;padding: 0 10px;">
                ...
                <ul style="position: relative;margin: 0;padding: 0;color: #000;list-style:none;">
                    <li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;">	You have recieved discount voucher</li>
                    <li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;color: #2F296D;font-weight: bold;">$Voucher_no of <?php if($Reward_percent > 0){ ?>
					$Reward_percent (%)
				<?php } else { ?>
