		...
		<div class="row">
			...
			<div class="col-12 howWorkWrapper">
				...
				<div class="workPointWrapper">
                 <span class="redTxt">Dine in,</span> Use your points when you dine-in by giving your waiter your mobile number when settling your bill. Follow the prompt on your phone to input your pin and redeem your points.
                </div>
			</div>
		</div>
	</div>
