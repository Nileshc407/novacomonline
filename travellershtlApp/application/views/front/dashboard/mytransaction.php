			...
			<?php 	if($Trans_details !=Null)
					{ 
						...
						{ 
							...
							{
								$TransType = "Expiry";
								$Purchase_amt = $row->Expired_points;
							}
						...
						?>
							...
							<li>
								<div class="cardMain d-flex align-items-center w-100">
									<div class="brandLogo"><img src="<?php echo $Outlet_logo; ?>"></div>
				...
				<?php	 $LVDatetoPrint = $DatetoPrint;
					...
					<div class="row">
						<div class="col-12 pr-2">
							<h6 class="text-center dark-bg p-2"><b>Not a single transaction yet?
							<br>
							<br>
							visit any of our locations to complete a transaction.</b></h6>
						</div>
					</div>	
			<?php }?>
                </ul>
