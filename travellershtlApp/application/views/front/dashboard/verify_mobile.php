					...
					<div class="card">
						<h5 class="m-0">Verify your phone number</h5>
							...
							<div class="text-center mt-5">
								...
								<a href="JavaScript:void(0);" onclick="Resend_opt();" id="myLink"><span class="font-weight-bold text-danger cursor">Resend</span></a>
							</div>
							<div class="text-center mt-5">
								<span class="d-block mobile-text">Kindly check your text message or email for the OTP code. For assistance, please call Guest Relations on <b>0719547940 / 0792763247</b> or write to us at <b>guest.relations@javahouseafrica.com</b></span>
							</div>
					</div>
				</div>		
			</div>
