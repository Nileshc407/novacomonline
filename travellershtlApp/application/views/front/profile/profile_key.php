	...
	<div class="container">
		<div class="row">
			<?php
				...
				{
				?>
					<div class="alert alert-dismissible" id="msgBox" role="alert" style="margin-left: 50px; background-color: #117086; !important">
			...
			<form  name="Update_profile" id="myForm" method="POST" action="<?php echo base_url()?>index.php/Cust_home/Update_img" enctype="multipart/form-data" onsubmit="return form_submit();">	
                ...
                <form class="perDetailForm" id="Updateprofile" method="post" action="<?php echo base_url();?>index.php/Cust_home/profile">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="datepicker1" name="dob" <?php if($Enroll_details->Date_of_birth != Null && $Enroll_details->Date_of_birth != "1970-01-01" && $Enroll_details->Date_of_birth != "0000-00-00 00:00:00") { ?> disabled value="<?php echo date('Y-m-d', strtotime($Enroll_details->Date_of_birth)); ?>" <?php } ?> required>
					</div>
					<?php if($Enroll_details->Date_of_birth != Null && $Enroll_details->Date_of_birth != "1970-01-01" && $Enroll_details->Date_of_birth != "0000-00-00 00:00:00") { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="phno" id="phno"  value="<?php echo $phnumber; ?>" maxlength="10" required>
						<div class="line"></div>
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" type="email" name="userEmailId" id="userEmailId" value="<?php echo $User_email_id; ?>" onblur="checkemail();" required>
					...
					<button class="redBtn w-100 text-center" type="submit">Submit</button>
               <?php //echo form_close(); ?>
			   </form>
            </div>
		</div>
