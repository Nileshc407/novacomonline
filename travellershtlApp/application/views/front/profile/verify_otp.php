				...
				<?php echo form_open_multipart('Cust_home/Verifiy_pin'); ?>
					...
					<div class="col-12 perDetailsWrapper">	
						<div class="form-group">
							...
							<input type="text" class="form-control" name="Pin" id="Pin" maxlength="5" required onkeyup="this.value=this.value.replace(/\D/g,'')">
							<div class="line"></div>
					...
					?>
						...
						<div class="row">
							 ...
							 <h6 class="form-label text-dange" style="margin-top:8px;"> <?php echo $this->session->flashdata('error_code'); ?></h6>
							 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>								
							</div>	
