							...
							if($_REQUEST['address_flag'] != '') { ?> 
								<div class="col-md-4 column clearfix">
									...
									<p> <?php
										...
										$address = (explode(",",$Address_type_details->Address)); 
										...
										echo $Address_type_details->Phone_no."<br>";
									?>
						...
						<?php 	} 
							...
							?>
									<div class="col-md-4 column clearfix">
										...
										<p>
										<?php
											$delivery_outlet_address = (explode(",",$delivery_outlet_details->Current_address)); 
											...
											echo $delivery_outlet_details->Phone_no."<br>";
										?>
										</p>
									</div>
							<?php } ?>								
