									...
									<select class="form-control select2" id="delivery_outlet" name="delivery_outlet" onchange="check_outlet_status(this.value); show_table_no_block(this.value);">
										<?php 
											...
											foreach($Sellerdetails as $row)
											{
												...
												if($To_City==$row['City']){
											?>
											   <option value="<?php echo $row['Enrollement_id']; ?>" <?php if($delivery_outlet == $row['Enrollement_id']){echo 'selected=selected'; } ?>> <?php echo "<b style=\"color:red\">".$row['First_name'].' '.$row['Last_name'].'</b> - '.$row['Current_address'].'('.$City_name.')'; ?>  <?php echo $Outlet_status; ?></option>
											<?php 
											}}
										?>
										<?php 
											...
											foreach($Sellerdetails as $row)
											{
												...
												if($To_City!=$row['City']){
											?>
											   <option value="<?php echo $row['Enrollement_id']; ?>"  <?php if($delivery_outlet == $row['Enrollement_id']){echo 'selected=selected'; } ?>> <?php echo "<b style=\"color:red\">".$row['First_name'].' '.$row['Last_name'].'</b> - '.$row['Current_address'].'('.$City_name.')'; ?>  <?php echo $Outlet_status2; ?></option>
											<?php 
											}}
										?>
									</select>
