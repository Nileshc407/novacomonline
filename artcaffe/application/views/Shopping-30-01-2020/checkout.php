						...
						<div class="row">							
							<div class="col-md-3">
									...
									<div class="card">
										...
										<?php
											$Customer_current_address1 = (explode(",",$Customer_current_address->Address)); 
							...
							<div class="col-md-3">
								<p class="text-center"><font style="font-weight: bold;font-size:18px;"> Work Address</font></p>
									...
									<div class="card">
									<?php 
										$Customer_work_address1 = (explode(",",$Customer_work_address->Address)); 
							...
							<div class="col-md-3">
								...
								<?php if($Customer_other_address ) { ?>
									<div class="card">
									<?php 
										$Customer_other_address1 = (explode(",",$Customer_other_address->Address)); 
						...
						<div class="row">
							<div class="col-md-6">
								<div class="modal-body">						
									...
									<?php $work_address = (explode(",",$Customer_work_address->Address)); ?> 
									<div class="form-group has-feedback">
							...
							<div class="col-md-6">
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="Phone_no" name="Phone_no" placeholder="Phone no." maxlength="10" value="<?php if($Customer_work_address->Phone_no != ""){echo  $Customer_work_address->Phone_no;} ?>" onkeypress="return isNumber(event)"  required>
									</div>		  
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="modal-body">						
									...
									<?php $other_address = (explode(",",$Customer_other_address->Address)); ?>
									<div class="form-group has-feedback">
										 <label for="exampleInputEmail1"><span class="required_info" style="font-size: 12px; font-style: italic; color: red;">*</span>&nbsp;Estate / Building Name</label>
							...
							<div class="col-md-6">
								<div class="modal-body">
									...
									<div class="form-group">
										<label for="pwd"><span class="required_info" style="font-size: 12px; font-style: italic; color: red;">*</span>&nbsp;Phone No.</label>
										<input type="text" class="form-control" id="Phone_no" name="Phone_no" placeholder="Phone No." maxlength="10" value="<?php if($Customer_other_address->Phone_no != ""){echo  $Customer_other_address->Phone_no;} ?>" onkeypress="return isNumber(event)" required>
									</div>		  
								</div>
							</div>
						</div>
