				...
				<div class="row addresses">
					<div class="col-sm-6">
						...
						<p><?php echo $outlet_address->Seller_name; ?>
							...
							<?php } ?>
							<br><?php echo $outlet_address->Current_address; ?>
							<br><?php echo $outlet_address->City_name; ?>, <?php echo $outlet_address->Country_name; ?>, <?php echo $outlet_address->Zipcode; ?>.
							<br><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span>&nbsp;<?php echo $outlet_address->Phone_no; ?>
							<br><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>&nbsp;<?php echo $outlet_address->User_email_id; ?>
						</p>
					</div>
				</div>
				<?php } ?>
