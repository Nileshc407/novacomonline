		...
		<header class="main-header">		
			<!-- Logo -->
				<a href="<?php echo base_url()?>index.php/Cust_home/home" class="logo">
					<span class="logo-mini" style="color:#332005;font-size: 30px; font-style: italic; font-family: FontAwesome;"><b>A</b></span>
					<img src="<?php echo $this->config->item('base_url')?>images/logo.png" class="img-responsive" style="height: 35px; margin: 7px auto;"/>
				</a>
			<!-- Logo -->
