...
<div class="main-footer">
	<div class="row">		
			<div class="col-sm-6 col-xs-12 footer-nav1" align="center" >
				<strong>Copyright &copy; 2015-2020 <?php echo $partner_Company_name; ?></a>.</strong> All rights reserved.
			</div>
			<div class="col-sm-6 col-xs-12 footer-nav2" align="center" >
				<strong>Powered By <?php echo $partner_Company_name; ?></a></strong>
			</div>		
...
/****************lora-sans-serif font*****************/
 @font-face{
    ...
    src:url("<?php echo base_url()?>/assets/fonts/lora/Lora-Bold.ttf") format("woff"),
    url("<?php echo base_url()?>/assets/fonts/lora/Lora-BoldItalic.ttf") format("opentype"),
    url("<?php echo base_url()?>/assets/fonts/lora/Lora-Italic.ttf") format("truetype");
    url("<?php echo base_url()?>/assets/fonts/lora/Lora-Regular.ttf") format("truetype");
}
.main-sidebar
{
