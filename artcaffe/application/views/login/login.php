...
<!-- //Modal3 -->
		...
		<?php } else { ?>
		<form action="<?php echo $this->config->item('base_url2')?>index.php/Login/Send_password_website/?Forgot_flag=<?php echo $Forgot_flag;?>" method="post"  class="login-form">
		<?php } ?>
...
body {
	<?php if((isset($_REQUEST['Member_login'])) || ($Member_flag==1)){ ?>
 background-image: url("<?php echo base_url(); ?>images/artcaffemember.jpg"); 
	<?php }else{ ?>
 background-image: url("<?php echo base_url(); ?>images/artcaffeoutlet.jpg"); 
 <?php } ?>
