	...
	<div class="row">
		<div class="col-12 howWorkWrapper">
			...
			<div class="workPointWrapper">
				...
				<span class="redTxt">Dine at</span> the Beach Bar and provide your 5 digit Code
			...
			<?php } else if($pt=='REDEEM') { ?> 
					...
					<span class="redTxt">Use your</span>  points towards payment of your bill. Provide your 5 Digit Code to the cashier when settling your bill, then Confirm or Deny Redemption of your points from your App Notification screen.
			<?php } ?>
			</div>
		</div>
	</div>
