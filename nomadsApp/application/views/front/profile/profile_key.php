	...
	<div class="container">
		<div class="row">
			<?php
				...
				{
				?>
					<div class="alert alert-dark alert-dismissible" id="msgBox" role="alert" style="margin-left: 50px;" style="background:#003153">
                ...
                <form class="perDetailForm" id="Updateprofile" method="post" action="<?php echo base_url();?>index.php/Cust_home/profile">
					...
					<?php /*if($Enroll_details->Date_of_birth != Null && $Enroll_details->Date_of_birth != "1970-01-01 00:00:00" && $Enroll_details->Date_of_birth != "0000-00-00 00:00:00") { ?>
						<div class="form-group">
							...
							<input type="date" class="form-control" id="datepicker1" name="dob" value="<?php echo date('Y-m-d', strtotime($Enroll_details->Date_of_birth)); ?>" >
						</div>
					<?php } else { ?>
						<?php }  */ ?> 
						...
						<div id="BirthDate" class="form-group">
							<label class="font-weight-bold">Date of Birth</label>
							<input type="date" name="dob" id="datepicker1"  class="form-control" value="<?php echo date('Y-m-d', strtotime( $Enroll_details->Date_of_birth)); ?>">
						</div>
                    ...
                    <div class="form-group input-group">
                        ...
                        <input type="tel" class="form-control w-100" name="phno" id="phno"  value="<?php echo $phnumber; ?>" maxlength="9" required>
						<div class="line"></div>
					...
					<div class="form-group input-group">
                        ...
                        <input type="text" class="form-control w-100" type="email" name="userEmailId" id="userEmailId" value="<?php echo $User_email_id; ?>" onblur="checkemail();" required>
					...
					<div class="form-group">
                        <label class="font-weight-bold w-100">Marital Status</label>
                        <label class="radioBtnMain mr-4">Single
                            <input type="radio" <?php if($Enroll_details->Married=='Single') { echo "checked"; } ?> name="Marital_status" value="Single" onclick="hide_anniversary('this.value');">
                            <span class="checkmark"></span>
                        </label>
                        <label class="radioBtnMain mr-4">Married
                            <input type="radio" <?php if($Enroll_details->Married=='Married') { echo "checked";} ?> name="Marital_status" value="Married" onclick="hide_anniversary('this.value');">
                            <span class="checkmark"></span>
                        </label>
                    </div>
					<div class="form-group" id="annversary_div">
						<label class="font-weight-bold">Anniversary Date</label>
						  <?php /*
								...
								?>	
							<?php }	*/ ?>								
								<input type="date" class="form-control" id="datepicker2" name="Wedding_annversary_date" placeholder="Anniversary Date" value="<?php echo date('Y-m-d', strtotime( $Enroll_details->Wedding_annversary_date)); ?>">							
