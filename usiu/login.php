    ...
    <div class="container">
        <div class="card card-container" style="padding: 5px 40px;">	
            ...
            <form class="form-signin" action="<?php echo base_url();?>index.php/login" method="post">
                ...
                <button class="btn btn-warning" style="background-color:#9CB4E0;color:#fff;" type="submit" value="Login">Sign in</button>
					...
					<div class="modal-body modal-body-sub_agile">
						<div class="col-md-12 modal_body_left modal_body_left1">
							...
							<form action="<?php echo base_url()?>index.php/Cust_home/enroll_new_member_website" method="post" >
								...
								<input type="submit" value="Register" class="btn btn-warning" style="background-color:#9CB4E0;color:#fff;">
...
<!-- //Modal3 -->
			...
			<form class="form-signin" action="<?php echo $this->config->item('base_url2')?>index.php/login" method="post">
                ...
                <button class="btn btn-warning" style="background-color:#9CB4E0;color:#fff;" type="submit" value="Login" onclick="javascript:loding();">Sign in</button>
				<input type="hidden" name="flag" value="2">
				<div id="m"></div>
            </form><!-- /form -->
			<?php echo form_close(); ?>
		...
		<div id="myModal14" class="modal fade" role="dialog" >
					<div class="modal-dialog">
						...
						<div class="modal-content">
						  ...
						  <div class="modal-header">
							<h4 class="modal-title" style="background-color:#9CB4E0;color:#fff;text-align:center">Forgot Password</h4>
						  </div>
