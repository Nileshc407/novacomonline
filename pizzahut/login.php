...
<?php
    ...
    <div class="container">
        <div class="card card-container" style="padding: 5px 40px;background-color:#ffffff;">	
            ...
            <p id="profile-name" class="profile-name-card" style="font-size:20px;text-align:left;margin-bottom: 10px;"><!--You are Home--> <?php if((isset($_REQUEST['Member_login'])) || ($Member_flag==1)){ ?><?php } else { ?> Welcome Back Business<?php } ?> </p>	
				...
				<div class="modal-content">
					...
					<div class="modal-body modal-body-sub_agile">
						<div class="col-md-12 modal_body_left modal_body_left1">
							 <img id="profile-img" class="profile-img-card" src="<?php echo base_url()?>assets/images/logo.jpg" style="width:40%"/>	
...
body {
 ...
 background-image: url("<?php echo base_url()?>assets/images/background_image.jpg"); 
	<?php }else{ ?>
 background-image: url("<?php echo base_url()?>assets/images/background_image.jpg"); 
 <?php } ?>
