		...
		<div style="background: #FFFFFF; border-radius: 36px 36px 0 0;">
			<div style="padding: 40px 25px 25px;">
				...
				<ul style="padding: 0;margin: 0;">
					...
					<li style="list-style: none; font-weight: 600; font-size: 14px; margin-bottom: 15px; color: #484848;"><span>Voucher Amount :</span> $Symbol_of_currency $VoucherDiscountAmt</li>
