...
class Send_notification 
{
	...
	/**************16-05-2020 nilesh purchase gift card**********************/
        ...
        //**************************Email Fuction Code*****************************
			...
			if($Template_type == "Email_verification" || $Template_type == "Forgot_password" || $Template_type == "Send_gift_card" || $Template_type == "Enroll" || $Template_type == "Member_verification_otp")
			{	
				if(!$mail->send()) 
				{  
					// echo"Mail Send";
