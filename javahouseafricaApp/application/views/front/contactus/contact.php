		...
		<div class="row">
			...
			<?php if(@$this->session->flashdata('error_code')){ ?>
                ...
                <form  name="TransferPoint" method="POST" action="<?php echo base_url()?>index.php/Cust_home/contactus" enctype="multipart/form-data" >
					...
					<button type="submit" class="redBtn w-100 text-center" value="submit" name="submit" onclick="set_loader();">Submit</button>
                </form>
            </div>
				  ...
				  <div class="modal-dialog modal-sm" style="margin-top: 65%;">
					...
					<div class="modal-content" id="loader_model">
					   <div class="modal-body" style="padding: 10px 0px;;">
						 <!--<img src="<?php echo base_url(); ?>assets/img/javaloader.gif" alt="" class="img-rounded img-responsive" width="80">-->
					   </div>       
					</div>    
					<!-- Modal content-->
				  </div>
...
function set_loader()
{
	var offerdetails = $("#message_detail").val();
	if(offerdetails !="")
	{
		setTimeout(function() 
		{
