	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 d-flex justify-content-between align-items-center hedMain">
				<div class="leftRight"><a href="<?php echo base_url();?>index.php/Cust_home/myprofile">
				<img src="<?php echo base_url(); ?>assets/img/back-icon.svg"></a></div>
...
<main class="padTop commonRoundWrapper">
    <div class="BoxHldr marBottom">
        <div class="container comHeight scrollbarMain">
            <div class="row">
                <div class="col-12">
                    <p>Nairobi Java House Limited (“Java House” “us”, “we”, or “our”) operates https://javahouseafrica.com (the “Site”). This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.</p>
                    ...
                    <b>Information Regarding Children and Persons Lacking Legal Capacity</b>
