	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 d-flex justify-content-between align-items-center hedMain">
				<div class="leftRight"><a href="<?php echo base_url();?>index.php/Cust_home/myprofile"><img src="<?php echo base_url(); ?>assets/img/back-icon.svg"></a></div>
...
<main class="padTop commonRoundWrapper">
    <div class="BoxHldr marBottom">
        <div class="container comHeight scrollbarMain">
            <div class="row">
                <div class="col-12">
                    <p>Please read these Terms and Conditions of use carefully before using this mobile application (the “App”). By
                        accessing or using this App or any functionality thereof on any computer, mobile phone, tablet, console or other
                         device (together “Devices” and each a “Device”), you confirm that you have read, understood and agreed to be
                         bound by these Terms and Conditions of Use and any other applicable law. If you do not agree to these Terms and
                         Conditions of Use, please do not access or use the App or any functionality thereof.</p>

                    <b>Owner and Operator Information</b>
                    <ul class="terms">
                    ...
                    <b>Authorised Users and Loyalty Points</b>
                    <ul class="terms">
                    ...
                    <b>Use and Unacceptable Use of the Application</b>
                    <ul class="terms">
                        <li>You may not do the following in relation to the Content of this App:
                            <ul>
                                <li>copy (whether by printing off onto paper, storing on disk, downloading or in any other way), distribute (including distributing copies), broadcast, alter or tamper with in any way or otherwiseuse any material contained in the App. These restrictions apply in relation to all or part of theContent;</li>
                    ...
                    <b>Charges for Use of the App</b>
                    <ul class="terms">
                    ...
                    <ul class="terms">
                        <li>Personal details and other information relating to you provided to Java House through this App will only be used in accordance with our Privacy Policy. Please read this carefully before continuing. By downloading the App you are consenting to use of this information in accordance with our Privacy Policy, which is incorporated into these Terms and Conditions of Use by this reference and available at <a href="#" target="_blank">https://javahouseafrica.com/privacy-policy</a></li>
                    </ul>

                    <b>User Information and User Generated Content</b>
                    <ul class="terms">
                    ...
                    <ul class="terms">
                        ...
                        <li>To the fullest extent permitted by law, Java House disclaims all warranties, express or implied, regarding
                            the operation and use of the App and any products accessed via the App. You understand and agree that
                             you use the App at your own risk and that you are solely responsible for your use and for any damage to
                            the Device through which you access the App, loss of data or any other harm of any kind which may result
                            from downloading, accessing or using the App.</li>
                        <li>To the fullest extent permitted by law, Java House shall under no circumstances whatsoever be liable to
                            you, whether in contract, tort (including negligence), breach of statutory duty or otherwise, arising under
                           or in connection with any products accessed via the App, your use of this App, or for your reliance on any
                           information or advice contained in the App.</li>
                    ...
                    <b>Changes to/operation of the App</b>
                    <ul class="terms">
                    ...
                    <b>Changes to these Terms and Conditions of Use</b>
                    <ul class="terms">
