	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 d-flex justify-content-between align-items-center hedMain">
				<div class="leftRight"><button onclick="location.href = '<?php echo base_url(); ?>index.php/Cust_home/front_home';">
				<img src="<?php echo base_url(); ?>assets/img/back-icon.svg"></button></div>
				<div><h1>Points History</h1></div>
				<div class="leftRight">&nbsp;</div>
			</div>
		</div>
	</div>
</header>
<main class="padTop commonRoundWrapper transactionsWrapper">
				...
				<div class="col-12">
					...
					$LVDatetoPrint = '0';
						...
						<ul class="transactionsHldr">
						  <?php if($DatetoPrint != $LVDatetoPrint){?> <li class="greyTxt">
						  <?php echo $DatetoPrint ;?></li> <?php } ?>
							...
							<li>
                                <div class="d-flex align-items-center w-100">
                                    <div class="titleTxtMain d-flex flex-column">
                                        ...
                                        <div class="cf d-flex align-items-center">
                                            <div class="flex-grow-1"><?php echo $TransType; ?></div>
                                        ...
                                        <div class="cf d-flex align-items-center">
											...
											<div><span class="greyTxt"><?php echo $lable; ?></span> <?php echo $Redeem_pts; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </li>
