...
class Login_model extends CI_Model {   
    ...
    {
		$query = 'SELECT E.Enrollement_id, E.First_name, E.Middle_name, E.Last_name, E.Card_id,E.User_email_id, E.User_pwd, E.pinno, E.User_id, E.timezone_entry, E.Country_id, C.Company_name,C.Company_id FROM igain_enrollment_master as E JOIN igain_company_master as C ON C.Company_id = E.Company_id WHERE C.Activated = 1 AND E.User_activated = 1 AND E.User_id = 1 AND E.User_email_id = "'.$username.'" AND E.Company_id = "'.$Company_id.'" AND BINARY E.User_pwd = "'.$password.'" ';		
