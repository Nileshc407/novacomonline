...
/*************************************************************************************/
	...
	{	
		...
		{	
			...
			$giftCard_amt = $this->input->post('giftCard_amt');
			$wallectBalance_amt = $this->input->post('wallectBalance_amt');
			$grand_total = ($grand_total - $redeem_voucher_amt) - $giftCard_amt;
			$grand_total = ($grand_total - $wallectBalance_amt);
