...
/*************14-05-2020 sandeep product voucher***************/
		if($Template_type == "Product_voucher")
        {
			...
			ob_start();	
			$Customer_name = $customer_details->First_name.' '.$customer_details->Last_name;
			// echo $Base_url."template/ProductVoucher.php";	
    ...
    { 
				...
				/**************Nilesh 09-07-2020 credit card*****************/
					...
					$wallectBalance_amt = $Email_content['wallectBalance_amt'];
					...
					if($wallectBalance_amt){
						$wallectBalance_amt=$wallectBalance_amt;
					} else {
						$wallectBalance_amt='0.00';
					}
				/***************Nilesh 09-07-2020 credit card*********************/
					if($DPO_Card_Amount) {
					...
					*/
										...
										$html ='
											...
											<div class="box purchuase-box">
												...
												/*--22-10-2020----*/
														if($Email_content['giftCardID'] && $Email_content['giftCardValue'] > 0  ){
															
															$html.='<p><b>Gift Card ('.$Email_content['giftCardID'].'):</b> '.$Symbol_of_currency.' '.$Email_content['giftCardValue'].'</p>';
														}
												/*--22-10-2020----*/
												...
												// echo"---Enable_wallet_flag--111-".$company_details->Enable_wallet_flag;
												if($company_details->Enable_wallet_flag == 1 ){
													$html.='<p><b>Wallet Applied:</b> '.$Symbol_of_currency.' '.number_format($wallectBalance_amt,2).'</p>';
												}
												$html.='<p><b>Credit Card (DPO):</b> '.$Symbol_of_currency.' '.$DPO_Card_Amount.'</p>
											</div>';
			...
			// echo"<br>---html---Purchase_order--1---".$html;						
								...
								<body style="background-image:url("'.$Base_url.'assets/img/statement-bg.jpg")">
										...
										<div class="custom-body">
											...
											<div class="box purchuase-box">
												...
												/*--22-10-2020--gift Card --*/
														if($Email_content['giftCardID'] && $Email_content['giftCardValue'] > 0  ){
															
															$html2.='<p><b>Gift Card ('.$Email_content['giftCardID'].'):</b> '.$Symbol_of_currency.' '.$Email_content['giftCardValue'].'</p>';
														}
												/*--22-10-2020--gift Card--*/
												
												$html2.='<p><b>Redeem '.$Company_Currency.' ('.$Cust_wish_redeem_point.'  ):</b> '.$Symbol_of_currency.' '.number_format($EquiRedeem,2).'</p>';
												// echo"---Enable_wallet_flag--222-".$company_details->Enable_wallet_flag;
												if($company_details->Enable_wallet_flag == 1 ){
													$html2.='<p><b>Wallet Applied:</b> '.$Symbol_of_currency.' '.number_format($wallectBalance_amt,2).'</p>';
												}
												$html2.='<p><b>Mpesa:</b> '.$Symbol_of_currency.' '.number_format($mpesa_BillAmount,2).'</p>
		...
		// echo"<br>----Purchase_order--2---".$html2;
    }		
								...
								<body style="background-image:url("'.$Base_url.'assets/img/statement-bg.jpg")">
										...
										<div class="custom-body">
											...
											<div class="box purchuase-box">
												...
												// echo"---Enable_wallet_flag--333--".$company_details->Enable_wallet_flag;
												if($company_details->Enable_wallet_flag ==1 ){
													$html.='<p><b>Wallet Applied:</b> '.$Symbol_of_currency.' '.number_format($wallectBalance_amt,2).'</p>';
												}
											$html.='</div>';
