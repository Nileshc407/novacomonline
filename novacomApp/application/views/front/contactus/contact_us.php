	...
	<div id="wrapper">
		...
		<div class="custom-body">
			<div class="box custom-form ptb-30">
				<form  name="TransferPoint" method="POST" action="<?php echo base_url()?>index.php/Cust_home/contactus_App" enctype="multipart/form-data" onsubmit="return form_submit();">	
					<div class="row">
						<div class="form-group col-12">
							<select class="form-control"  id="Sub_line" name="contact_subject" onchange="hide_query_type(this.value);" >
					...
					<div class="row">
						<div class="form-group col-12">
							<select  class="form-control" id="Sub_query_type" name="Sub_query_type" > 
					...
					<div class="row">
						<div class="form-group col-12">
							<textarea class="form-control"  rows="2" cols="50" name="offerdetails" id="message_detail"placeholder="Enter details" ></textarea>
							<div class="help-block1" style="float:center;"></div>
						</div>
					</div>
