					...
					<ul>
						<li>
							<a href="<?php echo base_url();?>index.php/Cust_home/mailbox">
								<div class="icon" style="background-color:#007AFF;">
									<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
										<g clip-path="url(#clip0)">
										<path d="M23.3022 3.47852H2.69673C2.3585 3.47852 2.04185 3.56167 1.75537 3.69873L12.9506 14.894L15.4599 12.4825C15.4599 12.4825 15.4601 12.4823 15.4601 12.4822C15.4602 12.4821 15.4604 12.482 15.4604 12.482L24.2439 3.69893C23.9574 3.56177 23.6405 3.47852 23.3022 3.47852Z" fill="white"/>
										<path d="M25.2799 4.73462L17.0142 13L25.2796 21.2654C25.4167 20.979 25.4999 20.6623 25.4999 20.3241V5.67563C25.4999 5.3376 25.4169 5.021 25.2799 4.73462Z" fill="white"/>
										<path d="M0.720215 4.73438C0.583154 5.02085 0.5 5.3375 0.5 5.67573V20.3242C0.5 20.6622 0.583057 20.9789 0.72002 21.2653L8.98579 12.9999L0.720215 4.73438Z" fill="white"/>
										<path d="M15.9784 14.036L13.4688 16.4478C13.3258 16.5908 13.1384 16.6624 12.951 16.6624C12.7637 16.6624 12.5762 16.5908 12.4332 16.4478L10.0213 14.0359L1.75537 22.3013C2.04189 22.4384 2.35874 22.5217 2.69707 22.5217H23.3025C23.6408 22.5217 23.9574 22.4385 24.2439 22.3015L15.9784 14.036Z" fill="white"/>
										</g>
										<defs>
										<clipPath id="clip0">
						...
						<li>
							<a href="<?php echo base_url();?>index.php/Cust_home/readnotifications">
								<div class="icon" style="background-color:#5AC8FA;">
									<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
										<g clip-path="url(#clip0)">
										<path d="M20.0068 12.296V0.25H5.99316V12.296L11.1884 17.4913C11.6723 17.9751 12.3157 18.2416 13 18.2416C13.6843 18.2416 14.3277 17.9751 14.8116 17.4913L20.0068 12.296Z" fill="white"/>
										<path d="M1.24995 7.55322L4.52788 10.8312V6.10938H0.525879C0.603711 6.65415 0.853857 7.15713 1.24995 7.55322Z" fill="white"/>
										...
										<path d="M21.4717 10.8312L24.7496 7.55323C25.1457 7.15713 25.3959 6.65415 25.4737 6.10938H21.4717V10.8312Z" fill="white"/>
										<path d="M7.30527 15.6798L0.5 8.87451V22.485L7.30527 15.6798Z" fill="white"/>
										<path d="M18.6948 15.6797L25.5001 22.485V8.87451L18.6948 15.6797Z" fill="white"/>
										</g>
										<defs>
										<clipPath id="clip0">
										<rect x="0.5" y="0.25" width="25" height="25" fill="white"/>
										</clipPath>
										</defs>
									</svg>
								</div>
