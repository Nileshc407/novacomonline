		...
		<div class="custom-body transparent">
			...
			<ul>
				<?php
					...
					/* https://ehp.online/artcaffe/index.php/Term_condition 
					https://ehp.online/artcaffe/index.php/Privacy_policy
					*/
                ...
                <li><a href="" <?php if($page==2){ ?> class="active" <?php } ?>>Terms and Conditions</a> 
                  <ul class="submenu"> </ul>
                </li>
                <li><a href="" <?php if($page==3){ ?> class="active" <?php } ?>>Privacy Policy</a>
                  <ul class="submenu"></ul>
                </li>
            </ul>
        </nav>
