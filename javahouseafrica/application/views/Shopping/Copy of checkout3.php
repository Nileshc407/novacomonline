					...
					<form method="post" action="<?php echo base_url()?>index.php/Shopping/place_order">
											...
											<tr>
												<td>
													<a href="<?php echo base_url()?>index.php/Shopping/product_details/?product_id=<?php echo $Product_details->serial; ?>">
														<img src="<?php echo base_url().$Product_details->picture; ?>" alt="White Blouse Armani">
													</a>
												</td>
												...
												<td>$<?php echo number_format($Product_details->price, 2); ?></td>
						...
						<div class="box-footer">
							...
							<div class="pull-right">
								...
								<input type="hidden" name="Order_total" value="<?php echo number_format($order_total, 2); ?>" />
							</div>
						</div>
					</form>
				</div>
