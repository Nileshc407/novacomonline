        ...
        <div class="col-md-12 clearfix" id="checkout">
            ...
            <div class="box">
                <ul class="nav nav-pills nav-justified">	
                    <li class="active"><a href="#" style="background-color: #004d72; border: none;"><i class="fa fa-eye"></i> &nbsp; Review Order</a></li>
                </ul>
                <div class="content">
								...
								<div class="table-responsive">
									<table class="table" style="border: 1px solid #ddd;">
										<tbody>
											...
											<?php } ?>
											<?php foreach($Company_details as $comp) { $Loyalty_enabled = $comp['Loyalty_enabled']; } 
											...
											<tr>
												...
												<td><b><?php echo $Symbol_of_currency; ?></b>&nbsp;<?php  echo number_format($Sub_total-$Redeem_amount-$mpesa_BillAmount,2); ?></td>
