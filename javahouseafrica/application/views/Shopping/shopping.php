...
<section class="content-header" style="border-bottom: 2px solid #d0112b !IMPORTANT;">
    <div class="row">	
		...
		<div class="col-md-8 col-xs-8">
           <p style="color: #004d72;"><b><br/>All orders made on this site are only for PICKUP at our <?php echo $Selected_Outlet_name; ?> branch but check us out on Glovo, Glovo Courier or  UberEats for  home deliveries.</b></p>
        </div>
        <div class="col-md-2 col-xs-2"> 
...
<section class="content">
    <div class="row">	
        <div class="col-md-6 col-md-offset-3" id="popup">
            <div class="alert alert-success text-center" role="alert" id="popup_info" style="background-color:#004d72 !IMPORTANT"></div>
        </div>
    </div>
    <div id="content">		
				...
				//******** sandeep **********************
						...
						<div class="col-md-2" style="margin-right:20px;">
							<div class="product" id="product1" style="height:250px;">									
								<div class="small-box bg-aqua" style="z-index: 0;  background-color: #004d72 !important;margin-bottom: 2px;">
		...
		<div class="row" style="background-color:#fa6255;">
  ...
  $.ajax(
		{
			...
			success: function (data)
			{
					if (data.cart_success_flag == 1)
					{
						...
						$("#cart11").load(location.href + " #cart11");
						$("#header11").load(location.href + " #header11");
						$("#menu11").load(location.href + " #menu11");
					} 
					else
					{
...
<?php } ?>
      ...
      window.location = '<?php echo base_url() ?>index.php/Shopping/MenuItems/?Sort_by_points_flag=' + filter + '&Sort_by_category_flag=' + Merchandize_category + '&Sort_by_merchant_flag=' + merchant + '&Sort_by_brand_flag=' + brand + '&Sort_by_gender_flag=' + gender+ '&Sort_by_item_name=' + item_name;
  } 
