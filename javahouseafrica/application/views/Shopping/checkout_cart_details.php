...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css1/responsive.css">
<!-- Responsive CSS -->
...
<section class="content-header" style="border-bottom: 2px solid #d0112b !IMPORTANT;">
	<br><h1>Checkout - Cart Details</h1>
</section>
	<!-- Main content -->
        ...
        <div class="row">
			<?php if(empty($cart_check)) { ?>
				<div class="col-md-12">
					...
					<p class="text-center">
						<a href="<?php echo base_url()?>index.php/Shopping/Outlet" class="btn btn-template-main">
			...
			<div class="col-md-12 clearfix" id="checkout">
				<div class="box">
					 <form method="post" action="<?php echo base_url()?>index.php/Shopping/CheckoutPayment" onsubmit ="return Validate_form();" id="SubmitForm">
						<ul class="nav nav-pills nav-justified">
							<li class="active" ><a href="#" style="background-color:#004d72; border:none;">Sub Total : <?php echo $Symbol_of_currency; ?>&nbsp;<?php echo number_format($_SESSION['Sub_total'],2); ?></a></li>
						</ul>
						<?php 
							...
							// echo "Total due-------".$_SESSION['Grand_total'];
						?>
						...
						<hr><?php //print_r($GiftCards) ?>
						<div class="custom-body payment-body">
							<div class="accordion" id="accordion">
								<!-- Accordion item 0 -->
								<div class="item">
									<div class="accordion-header" onclick="GiftCardFunction()">
								...
								<!-- Accordion item 1 -->
								<div class="item">
									<div class="accordion-header" onclick="VoucherFunction()">
									...
									<div id="collapse1" class="collapse" data-parent="#accordion">
										<div class="card-body">
											<select class="form-control" name="Discount_vouchers" id="Discount_vouchers">
												<option value="0_0">Select Voucher</option>	
													<?php 
													if($DiscountVouchers) { ?>
								...
								<!-- Accordion item 2 -->
								<div class="item">
									<div class="accordion-header" onclick="RedeemFunction()">
									...
									<div id="collapse2" class="collapse" data-parent="#accordion">
										<div class="card-body">
											<h4 class="point-count"> <?php echo $Available_bal.' '.$Company_Details->Currency_name; ?> available</h4>
											<div class="point-field">
											<input type="text" id="point_redeem" name="point_redeem" size="6" onkeyup="this.value=this.value.replace(/\D/g,'')" placeholder="Enter <?php echo $Company_Details->Currency_name; ?>" class="form-control">
								...
								<!-- Accordion item 3 -->
								<div class="item">
									<div class="accordion-header" onclick="MPESAFunction()">
							...
							<!----------------Nilesh 09-07-2020------------------>	
								<div class="item">
									<div class="accordion-header" onclick="CreditCardfunction()">
							...
							<div class="checkout-total" style="text-align:right;">
								...
								<!------------------Nilesh 09-07-2020 credit card ------------------->												
									...
									<input type='text' name='Paid_by_credit_card' id='Paid_by_credit_card' value="<?php echo $DPOCreditAmt; ?>" class="txt" readOnly></span></p>
									<?php } ?>												
								<!------------------Nilesh 09-07-2020 credit card ------------------->	
									...
									Total Due: <span class="float-right"><?php echo $Symbol_of_currency; ?>&nbsp;<input
																							...
																							readOnly style="border:none;"></span>
						...
						<div class="box-footer" style="padding:0px;margin-top:10px;background: #fff;border-top:none">
							<div class="row" >
								<div class="col-md-6 col-xs-6">
									<a href="<?php echo base_url()?>index.php/Shopping/view_cart" class="btn btn-default" id="ViewCartBtn">
...
/* -----------setVoucher------29-05-2020--------------- */
	...
	/* -----------Cart_redeem_amt------29-05-2020--------------- */
		...
		function cal_redeem_amt(redeemBY) 
		{
            ...
            // alert('reedem'+reedem);
            // alert('redeem_voucher_amt1'+redeem_voucher_amt1);
            // alert('giftCard_amt1'+giftCard_amt1);
	...
	$( document ).ready(function() 
	{
		<!-------------ravi---------------->
			...
			if(retrievedObject)
			{
				...
				// alert(retrievedObject[0].total_bill_amount);
...
{
  var x = document.getElementById("collapse0");
...
{
  var x = document.getElementById("collapse4");
  if (x.style.display === "none") {
    x.style.display = "block";
  } else {
    x.style.display = "none";
