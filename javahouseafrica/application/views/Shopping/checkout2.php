				...
				<div class="box">
					<form method="post" action="<?php echo base_url()?>index.php/Shopping/Card_details">
						<ul class="nav nav-pills nav-justified">
							<li class="active"><a href="#" style="background-color:#004d72; border:none;"><i class="fa fa-money"></i>Payment Method</a></li>
						</ul>
						<div>
							<div class="row">
								<div class="col-sm-6">
...
function Call_API()
{	
	var payment_auth_key= '<?php echo $payment_auth_key; ?>';
	...
	$.ajax({
		...
		success: function(data)
		{
			...
			$("#BillAmount2").html(response2.PaidAmount); 
