						...
						<div class="box-footer" style="padding:0px;margin-top:10px;background: #fff;border-top:none">
							<div class="row">
								<div class="col-md-6 col-xs-6">
									<a href="<?php echo base_url()?>index.php/Shopping/MenuItems" class="btn btn-default"><i class="fa fa-backward" aria-hidden="true"></i> Add More</a>
								</div>		
								
								<div class="col-md-6 col-xs-6" align="right">
									<a href="<?php echo base_url()?>index.php/Shopping/checkout_cart_details" class="btn btn-template-main" onclick="ClearlocalStorage();"><!--data-toggle="modal" data-target="#myModal1"-->
