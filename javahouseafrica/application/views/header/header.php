...
<script>
	...
	<!-----Loader-16-12-2020----->
		...
		.se-pre-con {
			...
			background: url(<?php echo base_url(); ?>images/javaloader-1.gif) center no-repeat #fff;
		}
		</style>
...
<body class="hold-transition skin-blue sidebar-mini">
		<!-- Loader-16-12-2020 Paste this code after body tag -->
    ...
    <div class="wrapper">
		...
		<header class="main-header">		
			<!-- Logo -->
				<a href="<?php echo base_url()?>index.php/Cust_home/home" class="logo">
					<span class="logo-mini" style="color:#fff;font-size: 30px; font-style: italic; font-family: FontAwesome;"><b>J</b></span>
					<img src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/javahouse_logo.png" class="img-responsive" style="height: 35px; margin: 7px auto;"/>
				</a>
			<!-- Logo -->
							...
							?>						
								<li class="dropdown messages-menu">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">
										<i class="fa fa-cart-plus fa-stack-2x"></i> &nbsp;&nbsp;
										<span  class="label pull-right bg-red"><span id="cart11"><?php echo $item_count; ?></span></span>
									</a>
									
									<ul class="dropdown-menu">
										<li class="header" id="header11">
											<div class="row">
					...
					<!---AMIT-END--------------------------->
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<img src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/javahouse_logo_colored.png" class="user-image" alt="<?php echo $Enroll_details->First_name.' '.$Enroll_details->Last_name; ?>" style="width: 30px; height: 30px;">
									<span class="hidden-xs" style="font-size: 22px;"><b><?php echo $Enroll_details->First_name.' '.$Enroll_details->Last_name; ?></b></span>
							...
							<ul class="dropdown-menu">
								<li class="user-header" style="height: auto;">
									...
									<img src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/javahouse_logo_colored.png" class="img-circle" alt="<?php echo $Enroll_details->First_name.' '.$Enroll_details->Last_name; ?>">
									<?php 
									/* if($Enroll_details->Photograph == "")
									{
									?>
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="<?php echo base_url()?>index.php/Cust_home/profile" class="btn btn-info btn-flat" style="background-color:#004d72;border:none;">Profile</a>
									</div>
									...
									<div class="pull-right">
										...
										if($smartphone_flag == 2) {
											?>
											<a href="<?php echo base_url()?>index.php/Cust_home/logout" class="btn btn-info btn-flat" style="background-color:#004d72;border:none;">Sign out</a>
										<?php 
										}
										?>
									</div>
		...
		<aside class="main-sidebar" style="position:fixed;background-image: url(https://ehpdemo.online/javahouseafrica/images/Menu.png) !IMPORTANT;background-repeat: no-repeat;background-size:231px 645px !IMPORTANT; ">
			<section class="sidebar">
				<ul class="sidebar-menu" style="width: 85%;">
					<li class="header" style="color: #000000;">Menu</li>
					<li class="treeview" <?php if($this->router->fetch_method()=="home"){ echo "style='background: #00b172;'";} ?> style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
						<a href="<?php echo base_url(); ?>index.php/Cust_home/home">
							<i class="fa fa-home"></i>
							<span>Home</span></i>
						</a>
					</li>
					<li class="treeview" <?php if($this->router->fetch_method()=="profile"){ echo "style='background: #00b172;'";} ?> style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
					...
					<li class="treeview" <?php if($this->router->fetch_method()=="merchantoffers"){ echo "style='background: #00b172;'";} ?> style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
					...
					<li class="treeview" style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
						<a href="">
						...
						<ul class="treeview-menu">
							<li <?php if($this->router->fetch_method()=="Add_Beneficiary_Category"){ echo "style='background: #00b172;'";} ?>>
								<a href="<?php echo base_url(); ?>index.php/Beneficiary/Add_Beneficiary_Category">
									<i class="fa fa-plus-square"></i>
									<span>Add Loyalty Programs </span>
								</a>
							</li>
							<li <?php if($this->router->fetch_method()=="Added_Beneficiary_accounts"){ echo "style='background: #00b172;'";} ?>>
				...
				<?php 
					...
					{ 
				?>
					<li class="treeview" <?php if($this->router->fetch_method()=="Load_buy_miles"){ echo "style='background: #00b172;'";} ?> style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
					...
					<li class="treeview" style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
						...
						<ul style="margin-right:15px;line-height:2.3;">
							...
							<?php 
								...
								{	
								?>
							<li <?php if($this->router->fetch_class()=="Shopping" && $this->router->fetch_method()!="my_orders"){ echo "style='background: #00b172;'";} ?>>
								<a href="<?php echo base_url()?>index.php/Shopping/Outlet">
								<!--<a href="<?php echo base_url()?>index.php/Shopping">-->
									<i class="fa fa-cart-plus"></i>
									<span>Order Online</span>
					...
					<li class="treeview" style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
						...
						<ul class="treeview-menu">
							<li>
								<a href="<?php echo base_url()?>index.php/Cust_home/CheckoutGiftCard" onclick="ClearlocalStorage();">
									<i class="fa fa-cart-plus"></i>
									<span>Buy Gift Card</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url()?>index.php/Cust_home/Vouchers_giftcard">
									<i class="fa fa-list-alt"></i>
									<span>Vouchers & Gift Cards</span>
								</a>
							</li>
						</ul>
						<?php /*  if( $this->router->fetch_class() == "Cust_home" || $this->router->fetch_method() == "CheckoutGiftCard"){ ?>
						<ul style="margin-right:15px;line-height:2.3;">
							<li <?php if($this->router->fetch_class()=="Cust_home" && $this->router->fetch_method() =="CheckoutGiftCard"){ echo "style='background: #00b172;'";} ?>>
								<a href="<?php echo base_url()?>index.php/Cust_home/CheckoutGiftCard" onclick="ClearlocalStorage();">
									<i class="fa fa-cart-plus"></i>
									<span>Buy Gift Card</span>
								</a>
							</li>
							<li <?php if($this->router->fetch_class()=="Cust_home" && $this->router->fetch_method() == "Vouchers_giftcard" || $this->router->fetch_method() == "Giftcard"){ echo "style='background: #00b172;'";} ?>>
								<a href="<?php echo base_url()?>index.php/Cust_home/Vouchers_giftcard">
									<i class="fa fa-list-alt"></i>
									<span>Vouchers & Gift Cards</span>
								</a>
					...
					<li class="treeview">
						...
						<ul style="margin-right:15px;line-height:2.3;">
							<li <?php if($this->router->fetch_class()=="Redemption_Catalogue" && $this->router->fetch_method()!="eVoucher_catalogue" ){ echo "style='background: #d0112b;'";} ?>>
								<a href="<?php echo base_url()?>index.php/Redemption_Catalogue">
									<i class="fa fa-shopping-cart"></i>
					...
					<li class="treeview" <?php if($this->router->fetch_method()=="transferpoints"){ echo "style='background: #00b172;'";} ?> style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
					...
					<!--<li class="treeview">
						...
						<ul style="margin-right:15px;line-height:2.3;">
							<li <?php if($this->router->fetch_class()=="transferpoints"){ echo "style='background: #00b172;'";} ?> >
								<a href="<?php echo base_url()?>index.php/Cust_home/transferpoints">
									<i class="fa fa-share"></i>
									<span>-To Other Members</span></i>
								</a>
					...
					<li class="treeview" style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
						...
						<ul class="treeview-menu">
							<!--<li <?php //if($this->router->fetch_method()=="Add_publisher_menu"){ echo "style='background: #d0112b;'";} ?>>
								<a href="<?php //echo base_url()?>index.php/Beneficiary/Add_publisher_menu">
									<i class="fa fa-plus-square"></i>
									<span>Add Beneficiary</span>
								</a>
							</li> -->
							<li <?php if($this->router->fetch_method()=="From_publisher"){ echo "style='background: #00b172;'";} ?>>
				...
				<?php /*  ?>
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<?php if($PromoCodeApply=='1') { ?>
								<li <?php if($this->router->fetch_method()=="promocode"){ echo "style='background: #d0112b;'";} ?>>
							...
							<?php if($AuctionBidApply=='1') { ?>
								<li <?php if($this->router->fetch_method()=="auctionbidding"){ echo "style='background: #d0112b;'";} ?>>
								...
								<?php } ?>
						<?php /*	<li <?php if($this->router->fetch_method()=="game_to_play"){ echo "style='background: #d0112b;'";} ?>>
					...
					<li class="treeview" <?php if($this->router->fetch_method()=="getsurvey"){ echo "style='background: #00b172;'";} ?> style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
					...
					<li <?php if($this->router->fetch_method()=="mailbox"){ echo "style='background: #00b172;'"; } ?> style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
					...
					<li class="treeview" <?php if($this->router->fetch_method()=="mystatement"){ echo "style='background: #00b172;'";} ?> style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
					...
					<li class="treeview" <?php if($this->router->fetch_method()=="contactus"){ echo "style='background: #00b172;'";} ?> style="border-bottom: 1px solid #FFFFFF !IMPORTANT;">
...
.box.box-info {
    border-top-color: #d0112b ! important;
}
.box.box-primary {
    border-top-color: #d0112b ! important;
}
...
.content-header {
    border-bottom: 2px solid #d0112b !IMPORTANT;
...
.skin-blue .sidebar-menu>li:hover>a,.skin-blue .sidebar-menu>li.active>a{
	color:#fff;background:#00b172;border-left-color:#d0112b
	}
