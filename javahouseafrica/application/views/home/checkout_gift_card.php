...
else
{
	...
	$Current_point_balance1=$Available_bal;
}
	...
	<section class="content">
        <div class="row">
			<div class="col-md-12 clearfix" id="checkout">
				<div class="box">
					 <form method="post" action="<?php echo base_url()?>index.php/Cust_home/CheckoutGiftCardPayment" onsubmit ="return Validate_form();" id="SubmitForm">
						...
						<div class="custom-body payment-body">
							...
							<div class="checkout-total">
								...
								<?php echo $Symbol_of_currency; ?>&nbsp;<input type='text' name='redeem_amt' id='redeem_amt' value="0.00" class="txt"  readOnly></span></p>
								...
								<!------------------Nilesh 09-07-2020 credit card ------------------->												
									...
									<input type='text' name='Paid_by_MPESA' id='Paid_by_MPESA' value="0.00" class="txt" readOnly></span></p>
								...
								<!------------------Nilesh 09-07-2020 credit card ------------------->	
									...
									<input type='text' id='total_bill_amount' class="txt" name='total_bill_amount' size='13' value="" readOnly></span>
							</div>
							<!----------------Nilesh 09-07-2020--------------------->
