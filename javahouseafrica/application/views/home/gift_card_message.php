			...
			<div class="col-md-12 clearfix text-center">
				...
				<div class="box">
					...
					<ul class="nav nav-pills nav-justified">
						...
						<li class="active"><a href="#"><i class="fa fa-check"></i><br>Thanks for your Gift Card Purchase!</a></li>
					</ul>
					...
					<script>
						...
						var gift_cardid = '<?php echo $gift_cardid; ?>';
						var gift_amt = '<?php echo $gift_amt; ?>';
						var Valid_till = '<?php echo $Valid_till; ?>';
						
						
						BootstrapDialog.show({
							closable: false,
							title: 'Application Information',
							message: 'Thanks for your Gift Card Purchase! <br> <br> Gift Card No : <b>'+gift_cardid+'</b> <br> Amount : <b>'+Symbol_of_currency+' '+gift_amt+'</b><br> Valid Till : <b>'+Valid_till+'</b> ',
							buttons: [{
								label: 'OK',
								action: function(dialog) {
									window.location='<?php echo base_url()?>index.php/Cust_home/CheckoutGiftCard';
								}
							}]
						});
						runjs(Title,msg);
