...
<?php echo form_open_multipart('Cust_home/merchantoffers'); ?>			
	...
	<?php 
		...
		?>
			...
			<div class="box box-info">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-md-6">
						<img src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/loyaltyoffer.png" width="100%" height="100%" align="center">
					</div>
					<div class="col-xs-12 col-md-3">
					</div>
				</div>    
								...
								<div class="col-md-4">				
									<div class="box box-widget widget-user-2">
										<div class="widget-user-header" id="offerDiv" style="background: <?php echo $color;?> !important;">	
											<div class="card-header"><img src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/javahouse_logo_colored.png" class="img-circle" width="150" height="152" style="margin-left: 49px;"/></div>
			...
			<div class="row">
				<img src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/line.png"  style="width:100%;">
			</div>
		<div class="box box-info">
			<div class="box-header with-border">
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<img src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/offer1.png" width="100%" height="100%" align="center">
				</div>
				<div class="col-xs-12 col-md-4">
					<img src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/offer2.png" width="100%" height="100%" align="center">
				</div>
				<div class="col-xs-12 col-md-4">
					<img src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/offer3.png" width="100%" height="100%" align="center">
				</div>
