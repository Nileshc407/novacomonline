			...
			<div class="col-md-12 clearfix text-center">
				...
				<div class="box">
					...
					<ul class="nav nav-pills nav-justified">
						...
						<li class="active"><a href="#"><i class="fa fa-check"></i><br>Thanks for your Gift Card Sent!</a></li>
					</ul>
					...
					<script>
						...
						BootstrapDialog.show({
							...
							message: '<b>'+Success_Message+'</b>',
							buttons: [{
								label: 'OK',
								action: function(dialog) {
									window.location='<?php echo base_url()?>index.php/Cust_home/Giftcard';
								}
							}]
						});
						runjs(Title,msg);
