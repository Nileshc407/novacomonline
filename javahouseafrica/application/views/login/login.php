...
<?php
    ...
    <div class="container">
        <div class="card card-container" style="padding: 5px 40px;background-color:rgba(16, 3, 0, 0.7);color: #fff;">	
            <img id="profile-img" class="profile-img-card" src="<?php echo $this->config->item('base_url2')?>images/javahouseafrica/javahouse_logo.png" />			
...
body {
 ...
 background-image: url("<?php echo $this->config->item('base_url2')?>images/javahouseafrica/javahouse_12_years.jpg"); 
	<?php }else{ ?>
 background-image: url("<?php echo $this->config->item('base_url2')?>images/javahouseafrica/javahouse_12_years.jpg"); 
 <?php } ?>
