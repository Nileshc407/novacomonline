...
class Login extends CI_Controller
{
	...
	public function index()
    {
			...
			$Redemption_Items = $this->Shopping_model->get_all_items(6,0,$Company_id12,0,0,0,0,0,'',0);
			...
			else
			{
				...
				else
				{
					...
					// exit;
					// redirect('https://www.figma.com/proto/SaRbjC9oRbFuaaoeJ3csyW/kukito_desk?node-id=4%3A20&scaling=min-zoom');
