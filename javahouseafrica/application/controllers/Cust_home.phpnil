...
class Cust_home extends CI_Controller
{
	...
	{ 
		...
		/*******************Nilesh Redirect URL  09-07-2020***************************/
			...
			$this->load->view('home/checkout_gift_card', $data);
		}
		else
		{
			redirect('Login', 'refresh');
	...
	public function CheckoutGiftCardPayment()
	{
		if($this->session->userdata('cust_logged_in'))
		{
			...
			$this->load->view('home/gift_card_message', $data);
		}
		else
		{
			redirect('Login', 'refresh');
	...
	{	
		if ($this->session->userdata('cust_logged_in')) {
            ...
            $this->load->view('home/vouchers_giftcard', $data);
        } else {
            redirect('login', 'refresh');
        }	
	}
	...
	{	
		if ($this->session->userdata('cust_logged_in')) {
            ...
            $this->load->view('home/mygiftcard', $data);
        } else {
            redirect('login', 'refresh');
        }
	}
                        ...
                        $logtimezone = $session_data['timezone_entry'];
							...
							$giftcard_details = $this->Igain_model->get_giftcard_balance($Gift_card,$Company_id);
                               ...
                               $Email_content2 = array(
                                ...
                                $this->load->view('home/Send_gift_card_msg', $data);
                            }
                        else {
							$this->load->view('home/Send_gift_card', $data);
						}	
			}
		 else {
            redirect('login', 'refresh');
