	...
	<div id="wrapper">
		...
		<header>
			...
			<nav>
				...
				<ul class="ul_light">
					...
					<li><a href="<?php echo base_url(); ?>index.php/Cust_home/front_home">View All Bands</a></li>
				</ul>
			</nav>
		</header>
		...
		<div class="custom-body">
			<div class="first-card">
				<img src="<?php echo base_url(); ?>assets/brand-0/images/animated.gif" alt="" class="d-block mx-auto"/>
			</div>
                        ...
                        <div id="accord1" class="collapse" aria-labelledby="accordion1" data-parent="#accordion-main">
                            <div class="card-body">
                                <div class="how-it-works-card">
                                	<div class="how-it-works-card-in">
                                		<i class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/brand-0/images/earn-points-01.svg"></i>
                                		<p><strong>Dine in</strong> at any of our restaurants and upon settling your bill you will be asked / inform your waiter that you are a Loyalty Member and give them your phone number (your unique identifier) for your points to be updated.</p>
                                	</div>
                                	<div class="how-it-works-card-in">
                                		<i class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/brand-0/images/earn-points-02.svg"></i>
                                		<p><strong>Order for delivery</strong> online or by calling. When confirming your order, your points will automatically be updated using your unique identifier (mobile number).</p>
                                	</div>
                                	<div class="how-it-works-card-in">
                                		<i class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/brand-0/images/earn-points-03.svg"></i>
                                		<p><strong>Shop online</strong> on the Artcaffe Market and upon confirmation of your order, your points will be automatically updated using your unique identifier (your mobile number).</p>
                                	</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="accord2" class="collapse" aria-labelledby="accordion2" data-parent="#accordion-main">
                            <div class="card-body">
                                <div class="how-it-works-card">
                                	<div class="how-it-works-card-in">
                                		<i class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/brand-0/images/earn-points-01.svg"></i>
                                		<p><strong>Dine in,</strong> upon settling your bill, you will be asked / inform your waiter you would like to use your points. Give them your mobile number and you will receive a notification prompting you confirm your intention to redeem your points.</p>
                                	</div>
                                	<div class="how-it-works-card-in">
                                		<i class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/brand-0/images/earn-points-02.svg"></i>
                                		<p><strong>Ordering for delivery online,</strong> at checkout tick the box that says “Redeem Points”. You will receive a notification on your phone to input your pin. When ordering for delivery by calling, upon confirming your order, your agent will ask / inform your agent you would like to redeem points. You will receive a notification on your phone prompting you confirm your intention to redeem your points.</p>
                                	</div>
                                </div>
                            </div>
                        </div>
