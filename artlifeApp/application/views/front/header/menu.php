	...
	<div class="custom-header">
         <div class="container">
            <div class="heading-wrap">
               ...
               <h2 class="title-name"><?php echo ucwords($Enroll_details->First_name).' '.ucwords($Enroll_details->Last_name); ?></h2>
          ...
          <nav class="menu-wrapper" style="z-index: 1 !IMPORTANT;">
            <ul class="parent-menu">
				...
				<?php /* ?>
				<li> <a href="<?php echo base_url();?>index.php/Cust_home/CheckoutGiftCard"><img src="<?php echo base_url(); ?>assets/img/ord.png">GIFT CARD</a></li> <?php */ ?>
				
				<li> <a href="<?php echo base_url();?>index.php/Cust_home/Vouchers_giftcard"><img src="<?php echo base_url(); ?>assets/img/state.png">MY VOUCHERS</a></li>
