				...
				<div class="row">
					<div class="col-md-12" style="padding:0; margin:0;">
						<div style="border-style:groove; border-color:#F8F8F8; padding:5; margin:5;">
							<img src="<?php echo $this->config->item('base_url2').'images/image3.png'; ?>" style="width:100%; height:100%;">
							<h6>Special Offer on Cakes Buy 1 and Get 1 Free</h6>
						</div>
					</div>
				</div>
			</div>
