...
class Enrollement_data_transform extends CI_Controller 
{
	...
	public function Enrollement_data_mapping()
	{
		...
		{			
			...
			$get_sellers = $this->Igain_model->get_company_sellers1($Company_id);
			$data['Seller_array'] = $get_sellers;		
	...
	public function insert_data_map()
	{
		if($this->session->userdata('logged_in'))
		{
			...
			$post_data['Column_Birth_Date'] = $this->input->post('Column_Birth_Date');
			/********************************************************************/
		...
		if($this->session->userdata('logged_in'))
		{
			...
			else
			{
				...
				foreach($UploadData as $row)
				{
					...
					/* echo"First_Name------".$FirstName."<br><br>";	
					echo"LastName------".$LastName."<br><br>";	
					echo"PhoneNo------".$PhoneNo."<br><br>";	
					echo"UserEmailID------".$UserEmailID."<br><br>";	
					echo"MembershipID------".$MembershipID."<br><br>";	 */
						
					if($PhoneNo !="" && $UserEmailID !="" && $MembershipID !="" )
					{
					...
					else
					{
						...
						$enroll_flag=0;
						/* echo"enroll_flag---here....------".$enroll_flag."<br>"; */
					}					
				}
