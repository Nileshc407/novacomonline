...
//************* akshay work start *************************************	
	...
	function enrollment_list()
	{
		if($this->session->userdata('logged_in'))
		{
			...
			else if($Sub_seller_admin == 1 && $data['userId'] == 7)
			{
				$data["results"] = $this->Enroll_model->Selected_company_customer_staff_list(0,0,$session_data['Company_id']);
			}
			else
			{
	...
	function enrollment()
	{
		if($this->session->userdata('logged_in'))
		{
			...
			$Sub_seller_admin = $session_data['Sub_seller_admin'];
			$Sub_seller_Enrollement_id = $session_data['Sub_seller_Enrollement_id'];
			$data['Sub_seller_admin'] = $Sub_seller_admin;
			if($Sub_seller_admin==1)
			{
                $Logged_user_enrollid=$Logged_user_enrollid;
			}
