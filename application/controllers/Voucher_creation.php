	...
	function index(){
		...
		if($this->session->userdata('logged_in'))
		{
			...
			{	
				...
				{
					$this->session->set_flashdata("error_code","Voucher Image size should be 100 KB");
						...
						if($POS_item) {
							...
							for($i=0; $i<count($POS_item); $i++){
								...
								$Post_child_data=array(
									...
									'Voucher_id'=>$result,
									'Voucher_type'=>$this->input->post('Voucher_type'),
									'Voucher_code'=>$this->input->post('Voucher_code'),'Voucher_issuance_type'=>$Voucher_issuance_type,'Company_merchandise_item_id'=>$Merchandize_Item_details->Company_merchandise_item_id,
								...
								$Post_child_data=array(
									...
									'Voucher_id'=>$result,
									'Voucher_type'=>$this->input->post('Voucher_type'),
									'Voucher_code'=>$this->input->post('Voucher_code'),'Voucher_issuance_type'=>$Voucher_issuance_type,									
									'Cost_price'=>$Cost_price,
									'Cost_in_points'=>$Cost_in_points,
									'Discount_percentage'=>$Discount_percentage,
									'Valid_from'=>$Valid_from,
			...
			else
			{
				...
				/*-----------------------------------Image Upload Code-----------------------------*/
					...
					$Update_data=array(
						...
						'Valid_till'=>$Valid_till,						
						'Voucher_name'=>$this->input->post('Voucher_name'),
						'Voucher_description'=>$this->input->post('Voucher_description'),'Voucher_issuance_type'=>$Voucher_issuance_type,					
						'Item_image1'=>$Item_image1,
						'Item_image2'=>$Item_image2,
						'Item_image3'=>$Item_image3,
						'Item_image4'=>$Item_image4,
