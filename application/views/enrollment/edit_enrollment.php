					...
					<?php 	} ?>
							<div class="row">
								<div class="col-sm-6">										
								  ...
								  <div class="form-group">
								   ...
								   <div class="form-group">
									...
									<textarea class="form-control" rows="3" name="alternativeAddress" id="alternativeAddress" placeholder="Enter alternative address" ><?php echo App_string_decrypt($results->Alternative_address); ?></textarea>
								  </div>
								  <div class="form-group">
								  ...
								  <?php if($Company_details->Enable_company_meal_flag == 1) { ?> 			
									 <div class="form-group">
										  Expire Monthend Balance ?
											<div class="col-sm-8" style=" margin-top:7px;">
											  <div class="form-check" style="float:left;">
												<label class="form-check-label">
												<input class="form-check-input" name="Expire_monthend_balance" type="radio"   value="1" <?php if($results->Expire_monthend_balance==1) {echo 'checked';}?> >Yes</label>
											  </div>
											  
											  <div class="form-check" style="margin-left:50px;">
												<label class="form-check-label">
												<input class="form-check-input" name="Expire_monthend_balance" type="radio"  value="0" <?php if($results->Expire_monthend_balance==0) {echo 'checked';}?> >No</label>
											  </div> 
											</div>
									</div>	
									<?php }else{echo "<input type='hidden' name='Expire_monthend_balance' value='0'>";} ?>	
								<?php
								...
								?>
									...
									<?php if($Company_details->Physical_card_link == 1) { ?>  
										<div class="form-group">
											<label for=""> Physical Card No.</label>
											<input type="text" maxlength="16" name="membership_id2" id="membership_id2" value="<?php echo $results->Card_id2; ?>" class="form-control" placeholder="Enter Physical Card No." onkeydown="return noenter(event)" > 
											<div class="help-block form-text with-errors form-control-feedback" id="help-block33"></div>
										</div>
									<?php }
									}
								?>								  
								 ...
								 <div class="form-group">
								  ...
								  <?php if($User_id == '1')
									...
									<div class="form-group" id="Select_tier">
										...
										<?php
											$_SESSION['Tier_id_SESSION']=$results->Tier_id;
						...
						<?php
							if($User_id == '1'){						
								if($Company_details->Club_flag==1 ) { ?>
							<div id="Member_additional_filed_div">
								<fieldset class="form-group">
								<legend><span>Member Additional Details</span></legend>
								<div class="row" >
									<div class="col-sm-6">
										<div class="form-group">
											<label for="">Email ID (Home)</label>
											<input type="text" name="homeEmailId" id="homeEmailId"  class="form-control" placeholder="Enter home email id" onblur="validateEmail(this.value);" value ="<?php if($results->User_email_id1 != Null ) { echo App_string_decrypt($results->User_email_id1); }?>">
											<div class="help-block21 form-text with-errors form-control-feedback"></div>
										</div>
										<div class="form-group">
											<label for="">Phone Number 2 <!--<span class="required_info">(Please enter without '+' and country code) </span>--></label>
											<input type="text" name="phno1" id="phno1"  class="form-control" placeholder="Enter Phone Number 2"  onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="13" data-error="Please enter phone number 2" value ="<?php if($results->Phone_no1 != Null ) { echo App_string_decrypt($results->Phone_no1); }?>">
											<div class="help-block22 form-text with-errors form-control-feedback"></div>
										</div>
										<div class="form-group">
											<label for="">Nationality 1</label>
											<select class="form-control" name="Nationality" id="Nationality">
											<option value="">Select Nationality</option>
											  <?php
											  if($Nationality_array !== Null){
													foreach($Nationality_array as $Nationality)
													{ ?>
														<option value="<?php echo $Nationality['name']; ?>" <?php if($results->Nationality == $Nationality['name']){ echo "selected"; } ?>><?php echo $Nationality['name']; ?></option>
														<?php 
													}
												}
												?>
										...
										<div class="form-group">
											<label for="">Nationality 2</label>
											<select class="form-control" name="Nationality1" id="Nationality1">
											<option value="">Select Nationality</option>
											  <?php
											    if($Nationality_array !== Null){
													foreach($Nationality_array as $Nationality1)
													{ ?>
														<option value="<?php echo $Nationality1['name']; ?>" <?php if($results->Nationality1 == $Nationality1['name']){ echo "selected"; } ?>><?php echo $Nationality1['name']; ?></option>
													<?php 
													}
												}
												?>
									...
									<div class="col-sm-6" >
										<div class="form-group">
											...
											<input type="text" name="Occupation"  id="Occupation" class="form-control" placeholder="Enter Occupation Details" value ="<?php echo $results->Occupation; ?>">
										</div>
										<div class="form-group">
											<label for="">Employer</label>
											<input type="text" name="Employer"  id="Employer" class="form-control"  placeholder="Enter Employer Details" value ="<?php echo $results->Employer; ?>">
										</div>
										<div class="form-group">
											<label for="">Blood Group</label>
											<input type="text" name="Blood_group"  id="Blood_group" class="form-control" placeholder="Enter Blood Group" value ="<?php echo $results->Blood_group; ?>">
										</div>
									</div>
								</div>
								</fieldset>
							...
							<div>								
								...
								<input type="hidden" readonly name="Time_Zone" readonly value="<?php echo $results->timezone_entry; ?>" />
								<input type="hidden" readonly name="Tier_update_flag" readonly value="<?php echo $results->Tier_update_flag; ?>" />
								<input type="hidden" readonly name="Tier_update_date" readonly value="<?php echo $results->Tier_update_date; ?>" />
							</div>
							<?php
							}
					if($User_id == '2')
					...
					<div>
						...
						<div class="row">
							...
							<div class="col-sm-6" >
								...
								<?php if ($results50 != NULL && $results50->Sub_seller_admin > '0') { ?>
								<div class="form-group">
							...
							<div class="row" >
								<div class="col-sm-6" >
									<div class="form-group" id="sub_merchant">
										...
										<label class="radio-inline">
										<input type="radio" name="Sub_seller_admin1" id="Sub_seller_admin1" onclick="hideshow_supervisor1(this.value);" value="1" <?php if($results->Sub_seller_admin==1){echo "checked";} ?> <?php if($Sub_seller_admin == 1 && $userId == 7){?> disabled <?php }  ?>>Yes</label>
											<label class="radio-inline">
...
$(document).ready(function()
{
	...
	{	
		if( $("#phno1").val() != "" )
		{
			var Phone_no1 = $("#phno1").val();
			var Company_id = '<?php echo $Enroll_details->Company_id; ?>';
			var Country_id = '<?php echo $Enroll_details->Country; ?>';
			
			var Phone = '<?php echo App_string_decrypt($results->Phone_no1); ?>';

			if(Phone != Phone_no1)
			{
				$.ajax({
					  type: "POST",
					  data: {Phone_no1: Phone_no1, Company_id: Company_id, Country_id: Country_id},
					  url: "<?php echo base_url()?>index.php/Enrollmentc/check_phone_no1",
					  success: function(data)
					  {
						if(data.length == 13)
						{
							...
							var msg1 = 'Already exist';
							$('.help-block22').show();
							$('.help-block22').html(msg1);
							$("#phno1").addClass("form-control has-error");
							// setTimeout(function(){ $('#help-block1').hide(); }, 3000);
							return false;
						}
						else if(data.length != 13)
						{
							$("#phno1").removeClass("has-error");
							$(".help-block22").html("");
		...
		{
			var msg1 = 'Please enter phone number 2';
			$('.help-block22').show();
			$('.help-block22').html(msg1);
			setTimeout(function(){ $('.help-block22').hide(); }, 3000);
			return false;
		}
	});
	...
	$('#homeEmailId').blur(function()
	{
		var validEmailId = ValidateEmail1($("#homeEmailId").val());
		
		if( $("#homeEmailId").val() != "" )
		{
			var emailID = '<?php echo App_string_decrypt($results->User_email_id1); ?>';
			
			if(emailID != $("#homeEmailId").val() )
			{
				...
				$.ajax({
					  type: "POST",
					  data: {homeEmailId: homeEmailId, Company_id: Company_id, userId: userId},
					  url: "<?php echo base_url()?>index.php/Enrollmentc/check_homeEmailId",
					  success: function(data)
					  {
							if(data.length == 13)
							{
								...
								var msg1 = 'Already exist';
								$('.help-block21').show();
								$('.help-block21').html(msg1);
								$("#homeEmailId").addClass("form-control has-error");
								// setTimeout(function(){ $('.help-block2').hide(); }, 3000);
								return false; 
							}
							else
							{
								$("#homeEmailId").removeClass("has-error");
								$(".help-block21").html("");
							}
					  }
				});
	...
	function ValidateEmail1(mail) 
	{
		...
		$('.help-block21').show();
		$('.help-block21').css("color","red");
		$('.help-block21').html(msg1);
		//setTimeout(function(){ $('.help-block0').hide(); }, 3000);
		return false;
	}
	$('#membership_id2').blur(function()
{
	if( $("#membership_id2").val()  == "" )
	{
		$("#membership_id2").val("");
		var msg1 = 'Please enter Physical card no.';
		$('#help-block33').show();
		$('#help-block33').html(msg1);
		$("#membership_id2").addClass("form-control has-error");
	...
	{
		var membership_id2 = $("#membership_id2").val();
		var Company_id = '<?php echo $Company_id; ?>';
		$.ajax({
			  type: "POST",
			  data: {card_id2: membership_id2, Company_id: Company_id},
			  url: "<?php echo base_url()?>index.php/Enrollmentc/check_card_id2",
			  success: function(data)
			{
				if(data.length == 13)
				{
				...
				{
					$("#membership_id2").removeClass("has-error");
					$("#help-block33").html("");
				}
			}
		});
