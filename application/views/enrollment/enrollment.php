	...
	<div class="content-box">
		<div class="row">
			...
			?>
				...
				<?php 	} ?>
							<div class="row">
								<div class="col-sm-6">										
								   ...
								   <div class="form-group">
									...
									<option value="">Select country</option>
									  <?php
										...
										foreach($Country_array as $Country_array)
										{
											if($Country_id == $Country_array['id']) {
												echo "<option value=".$Country_array['id']." selected>".$Country_array['name']."</option>";
											}
											else
											{
												echo "<option value=".$Country_array['id'].">".$Country_array['name']."</option>";
											}
								  ...
								  <div class="form-group">
									...
									<textarea class="form-control" rows="3" name="alternativeAddress" id="alternativeAddress"  placeholder="Enter alternative address"></textarea>
								  </div> 
								  <div class="form-group">
										  ...
										  Expire Monthend Balance ?
											<div class="col-sm-8" style=" margin-top:7px;">
											  <div class="form-check" style="float:left;">
												...
												<input class="form-check-input" name="Expire_monthend_balance" type="radio"   value="1">Yes</label>
											  </div>
											  
											  <div class="form-check" style="margin-left:50px;">
												<label class="form-check-label">
												<input class="form-check-input" name="Expire_monthend_balance" type="radio"  value="0" checked>No</label>
											  </div> 
											</div>
									</div>	
								...
								<div class="col-sm-6">
								  <div class="form-group">
									...
									<option value="">Select user type</option>
									  ...
									  // $remain_lic=0;
										...
										if($Sub_seller_admin == 1 && $userId == 7)
										{
											echo "<option value='7'>Staff Users</option>";
										}?>
									</select>
									<div class="help-block form-text with-errors form-control-feedback"></div>
								  </div>
								 ...
								 <?php if($Company_details->Physical_card_link == '1') { ?>
								  <div id="Membership_Id2" style="display:none">
								   <div class="form-group">
									<label for=""><span class="required_info">* </span> Physical Card No.</label>
										<input type="text" maxlength="16" name="card_id2" id="card_id2"  class="form-control" placeholder="Enter Physical Card no. id2" data-error="Please enter Physical card no."  onkeydown="return noenter(event)" />
							...
							<?php
									...
									<div class="form-group" id="Select_tier">
										<label for=""><span class="required_info">* </span> Select Tier</label> <!---- onchange="get_tier_details(this.value);"--->
							...
							<?php if($Company_details->Club_flag==1 ) { ?>
							<div id="Member_additional_filed_div" style="display:none;">
								...
								<div class="row" >
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input type="text" name="homeEmailId" id="homeEmailId"  class="form-control" placeholder="Enter home email id" onblur="validateEmail(this.value);">
										...
										<div class="form-group">
											...
											<input type="text" name="phno1" id="phno1"  class="form-control" placeholder="Enter Phone Number 2"  onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="13" data-error="Please enter phone number 2"/>
											...
											<option value="">Select Nationality</option>
											  <?php
											    if($Nationality_array !== Null){
													...
													{
														echo "<option value=".$Nationality1['name'].">".$Nationality1['name']."</option>";
													}
												}
												?>
											</select>
									...
									<div class="col-sm-6" >
										<div class="form-group">
											...
											<input type="text" name="Occupation"  id="Occupation" class="form-control" placeholder="Enter Occupation Details" />
										</div>
										<div class="form-group">
											<label for="">Employer</label>
											<input type="text" name="Employer"  id="Employer" class="form-control"  placeholder="Enter Employer Details" />
										</div>
										<div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6" >
										<div class="form-group" id="sub_merchant">
											...
											<label class="radio-inline">
												<input type="radio" name="Supervisor1" id="Supervisor1" onclick="hideshow_supervisor1(this.value);" value="1" <?php if($Sub_seller_admin == 1 && $userId == 7){?> disabled <?php } else { ?> checked <?php } ?>>Yes</label>
												<label class="radio-inline">
												
												<input type="radio" name="Supervisor1" id="Supervisor1" onclick="hideshow_supervisor1(this.value);" value="0" <?php if($Sub_seller_admin == 1 && $userId == 7){?> checked <?php } ?>>No
											</label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group" id="Supervisor_list_div1" <?php if($Sub_seller_admin == 1 && $userId == 7){ }else{?> style="display:none"<?php } ?>>
											<label for="">Select Department / Outlet or Head</label>
											<select class="form-control" name="Supervisor_Enrollement_id1" id="Supervisor_Enrollement_id1" data-error="Please select">
											<option value="">Select</option>
											<?php
				...
				<div class="element-wrapper">											
					<div class="element-box">
					<?php if($results != NULL) { ?> <h6 class="form-header">Enrollments</h6><?php } else { ?> 
					<h6 class="form-header" style="text-align: center;">
					 <a href="<?php echo base_url()?>index.php/Enrollmentc/enrollment_list">Click Here to View Enrollments</a>
					  </h6> <?php } ?>                 
...
function hide_show_merchant(selectVal)
{
	if(selectVal =='2' || selectVal =='4'  )
	{
		...
		$("#Membership_Id").hide();
		$("#Membership_Id2").hide();
		$("#Member_additional_filed_div").hide();
	...
	else if(selectVal =='7')
	{
		...
		<?php if($Sub_seller_admin == 1 && $userId == 7){ ?>
	...
	else
	{
		...
		$("#Membership_Id").show();
		$("#Membership_Id2").show();
		$("#Member_additional_filed_div").show();
		...
		$("#card_id2").attr("required","required");
...
$('#card_id2').blur(function()
{
	if( $("#card_id2").val()  == "" )
	{
		...
		$("#card_id2").addClass("form-control has-error");
		// setTimeout(function(){ $('.help-block3').hide(); }, 3000);
		return false;
	...
	{
		var card_id2 = $("#card_id2").val();
		var Company_id = '<?php echo $Company_id; ?>';
		$.ajax({
			  type: "POST",
			  data: {card_id2: card_id2, Company_id: Company_id},
			  ...
			  success: function(data)
			{
				...
				{
					$("#card_id2").removeClass("has-error");
					$("#help-block33").html("");
				}
			}
		});
...
$('#userEmailId').bind("cut copy paste",function(e) {
 ...
 Get_states('<?php echo $Country_id; ?>');
