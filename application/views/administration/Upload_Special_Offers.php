				...
				<?php
						...
						<tr>
									<td>
										...
										<a href="javascript:void(0);" class="danger"  onclick="delete_me('<?php echo $row->Brand_id;?>','All Special offer images for selected Brand','','Administration/delete_special_offer_images/?Brand_id');" title="Delete"  data-target="#deleteModal" data-toggle="modal" >
