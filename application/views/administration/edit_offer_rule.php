						...
						<div class="panel panel-default">
						  ...
						  <div class="form-group">
								...
								<select class="form-control" name="Buy_item" required="required"  <?php if($Check_offer_sent==1){echo 'disabled';} ?>>
									...
									<option <?php if($results->Buy_item==15){echo 'selected';} ?>  value="15">15</option>
									<option <?php if($results->Buy_item==20){echo 'selected';} ?>  value="20">20</option>
									<option <?php if($results->Buy_item==30){echo 'selected';} ?>  value="30">30</option>
									<option <?php if($results->Buy_item==40){echo 'selected';} ?>  value="40">40</option>
									<option <?php if($results->Buy_item==50){echo 'selected';} ?>  value="50">50</option>
								</select>							
							</div>
						  </div>
						</div>
