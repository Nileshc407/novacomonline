					...
					<div class="row">
						<div class="col-sm-6">
							  ...
							  <div class="form-group">
								...
								<input class="form-control"  name="Parameter1" id="Parameter1"  type="text" placeholder="Enter Username"  data-error="Please enter Username" >
								<div class="help-block form-text with-errors form-control-feedback" id="Parameter1"></div>
							  </div> 
							  <div class="form-group">
								<label for=""> Parameter3 (Sender ID) </label>								
								<input class="form-control"  name="Parameter3" id="Parameter3"  type="text" placeholder="Enter Sender ID"   data-error="Please enter Sender ID" >
							...
							<div class="col-sm-6">
								...
								<div class="form-group">
									...
									<input class="form-control"  name="Parameter2" id="Parameter2"  type="text" placeholder="Enter Password"  data-error="Please enter Password" >
									<div class="help-block form-text with-errors form-control-feedback" id="Provider_name"></div>
								</div>
								<div class="form-group">
									<label for="">  Parameter4 (Auth Key) </label>								
									<input class="form-control"  name="Parameter4" id="Parameter4"  type="text" placeholder="Enter Auth Key"  data-error="Please enter Auth Key" >
