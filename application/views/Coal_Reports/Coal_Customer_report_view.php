							  ...
							  <div class="form-group">
								...
								<select class="form-control" name="transaction_type_id" id="transaction_type_id" required="required" data-error="Please select transaction type">
									...
									<?php	
										...
										if($Enable_wallet_flag==1)
										{
											array_push($transactionTypes,"30","31");
										}
					  ...
					  <div class="table-responsive">
						<table id="dataTable1" width="100%" class="table table-striped table-lightfont">
							<thead>
								...
								if($Enable_wallet_flag==1)
								{
									echo '<th>Wallet Amount ('.$Symbol_currency.')</th>';
								}
								?>
								...
								<?php 
									if($Enable_wallet_flag==0)
									{
										echo '<th>Expired'.$Company_details->Currency_name.'</th>';
									}
									?>
								</tr>
								<?php }
								...
								?>
									...
									if($Enable_wallet_flag==1)
									{
										echo '<th>Total Wallet Amount ('.$Symbol_currency.')</th>';
									}
									?>	
									...
									if($Enable_wallet_flag==0)
									{
										echo '<th>Total Expired'.$Company_details->Currency_name.'</th>';
									}
									?>
						...
						if($Trans_Records != NULL)
						{
							...
							foreach($Trans_Records as $row)
							{
								...
								if($report_type == 1)//Details
								{
									...
									if($Enable_wallet_flag==1){echo "<td>".$row->Wallet_amount."</td>";}
								...
								if($report_type==2)
								{
									...
									if($row->Total_Wallet_amount==0)
									{
										$row->Total_Wallet_amount="-";
									}
									...
									?>
										...
										<?php if($Enable_wallet_flag==1)
									{ echo '<td>'.$row->Total_Wallet_amount.'</td>'; } ?> 
										<td><?php echo $row->Total_Redeem;?></td>
										<td><?php echo $row->Total_Paid_amount;?></td>
										<?php if($Enable_wallet_flag==0)
									{echo '<td> '.$row->Total_Expired_points.'</td>';}?>
										</tr>
								<?php   
								}
