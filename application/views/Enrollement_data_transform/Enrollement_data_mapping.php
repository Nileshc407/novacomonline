			  ...
			  <div class="element-box">
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-6">
						...
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Birth_Date" id="Column_Birth_Date" type="text" placeholder="Enter Column No. Birth Date" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter column number of birth date">
						<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
