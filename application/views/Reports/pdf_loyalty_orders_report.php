						...
						if(count($Trans_Records) > 0)
						{
							foreach($Trans_Records as $row)
							{
								...
								if($transaction_from==0 || $transaction_from==2)
								{
									...
									$POS_discount = $ci_object->Report_model->Get_outlet_pos_discount_summary($Company_id, $start_date, $end_date, 2,$row->Seller);
								...
								echo "<td>".number_format(round($Total_discount1),2)."</td>";
