                        ...
                        <div class="col-sm-3 col-xxxl-3">
                          <a class="element-box el-tablo highlight" href="#" style="min-height: 130px;">
							...
							<?php 
								...
								$Points_liability = $Total_Gained_Points - $Total_Used; ?>
                    ...
                    <div class="element-content">
                      <div class="row">
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo highlight" href="#" style="min-height: 130px;">
                            <div class="label">
                              Total Vouchers Liability
                            </div>
                            <div class="value counter-count+" id="count1">
							<?php 
								$Issued_vouchers = round($Issued_vouchers);
								$Used_vouchers = round($Used_vouchers);
								$Vouchers_liability = $Issued_vouchers - $Used_vouchers; ?>
								
                              <?php echo number_format($Vouchers_liability) ;?>
                            </div>
                            <div class="trending trending-up-basic">
						...
						<div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo highlight" href="#" style="min-height: 130px;">
                            ...
                            <div class="value counter-count+" id="count1">
                              <?php echo number_format($Issued_vouchers) ;?>
                            </div>
                            <div class="trending trending-up-basic">
                              <span>Count</span><i class="os-icon os-icon-arrow-up2"></i>
                            </div>
                        ...
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo highlight" href="#" style="min-height: 130px;">
                            ...
                            <div class="value counter-count+">
                              <?php echo number_format($Used_vouchers) ;?>
                            </div>
                            <div class="trending trending-up-basic">
                              <span>Count</span><i class="os-icon os-icon-arrow-up2"></i>
                            </div>
					  ...
					  <div class="row">
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo highlight" href="#" style="min-height: 130px;">
                            ...
                            <div class="value counter-count+" id="count1">
							<?php 
								$Total_issued_value = round($Vouchers_issued_value->Total_issued_value);
								$Total_used_value = round($Vouchers_used_value->Total_used_value);
