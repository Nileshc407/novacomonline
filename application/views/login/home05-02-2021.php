	...
	/***************************************************get_popular_category****************/
	   ...
	   function Call_back()
	   {
		   ...
		   $('#Menu_group').show();
	   		...
	   		/* if ($("#donutChart_items").length) {
							
		$("#donutChart_items_label").html(Merchandize_category_nameArr21[0]);	
      var donutChart11 = $("#donutChart_items");
// alert(Merchandize_item_nameArr);
// alert(Total_qtyArr21);
      // donut chart data
      var data11 = {
        labels: [Merchandize_item_nameArr[0],Merchandize_item_nameArr[1],Merchandize_item_nameArr[2],Merchandize_item_nameArr[3],Merchandize_item_nameArr[4],Merchandize_item_nameArr[5],Merchandize_item_nameArr[6],Merchandize_item_nameArr[7],Merchandize_item_nameArr[8],Merchandize_item_nameArr[9],Merchandize_item_nameArr[10]],
        datasets: [{
          data: [Total_qtyArr21[0],Total_qtyArr21[1],Total_qtyArr21[2],Total_qtyArr21[3],Total_qtyArr21[4],Total_qtyArr21[5],Total_qtyArr21[6],Total_qtyArr21[7],Total_qtyArr21[8],Total_qtyArr21[9],Total_qtyArr21[10]],
          backgroundColor: ["#f37070", "#4ecc48","#0066ff", "#ff00ff","#ffff00","#ff8000","#aaff00","#bf00ff","#00ffff","#0080ff"],
          hoverBackgroundColor: ["#e65252", "#24b314","#4d94ff", "#ff4dff","#ffff4d","#ffa64d","#c4ff4d","#d24dff","#4dffff","#4da6ff"],
          borderWidth: 0
        }]
      };
