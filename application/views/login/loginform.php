...
<body style="">
    ...
    <div class="container">
        <div class="card card-container">	
            ...
            <p id="profile-name" class="profile-name-card" style="font-size:20px;text-align:left;margin-bottom: 10px;">Welcome Back</p>	<?php echo "codeigniter version---".CI_VERSION; ?>
