    ...
    <div style="margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">      
		...
		<div style="padding: 0px 20px;">
			<h2 class="text-center" style="margin-top: 0px;">
			   <?php				
						if($Transaction_type == 1){echo "Credit ".$Company_details->Currency_name." Receipt";}
						if($Transaction_type == 2 || $Transaction_type == 12){echo "Purchase Receipt";}
						if($Transaction_type == 3 || $Transaction_type == 10){echo "Debit ".$Company_details->Currency_name." Receipt";}
			...
			<div class="table-responsive">
				...
				<?php if($Transaction_type == 2){ ?>
				  ...
				  <?php } else { ?>
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px; ">			
							<?php if($Transaction_type == 1){ echo $Company_details->Currency_name." Issued"; }
								else if($Transaction_type == 10 || $Transaction_type == 3){ echo "Total ".$Company_details->Currency_name." Debited"; }
