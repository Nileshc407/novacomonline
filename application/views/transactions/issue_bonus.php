                    ...
                    <div class="element-box">
						...
						<div class="col-sm-8">
							<div class="form-group">
								...
								<input class="form-control" data-error="Enter Membership ID or Phone No" placeholder="Enter Membership" required="required" type="text" name="cardId" id="cardId">
                ...
                <div class="element-wrapper">                
                    <div class="element-box">
                        <h5 class="form-header">
                            <?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Meal Topup Points';}else{echo "Topup";} ?>
                        </h5>                  
                            ...
                            <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Name</th>
                                        <th>Membership ID</th>
                                       <th><?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Meal Topup';}else{echo "Topup";} ?></th>
									   <th>Source</th>
                                ...
                                <tbody>
                                      <?php foreach ($results as $row) { ?>
                                        <tr>
											...
											<td><?php if($row->Mpesa_TransID !="") { echo "Mobile App"; } else { echo "Application"; } ?></td>
                                        </tr>
                                      <?php } ?>
                                </tbody>
                            </table>
