                        ...
                        <div class="form-group">
                         ...
                         <?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){ ?>
						   ...
						   <div class="form-group" id="Redeem_feedback" >
                                <label for="exampleInputEmail1"> Adjustment <?php echo $Company_details->Currency_name; ?></label>
						   ...
						   <div class="form-group" id="Redeem_feedback" >
                                <label for="exampleInputEmail1"> Adjustment / Debit <?php echo $Company_details->Currency_name; ?></label>
...
function Check_redeem_points(Points)
{
	...
	{
		$("#RedeemPoints").html(""); //Rakesh Added this check 06-02-2023
		...
		// Rakesh commented everything below
		/* if(Points >  parseInt(Seller_redemption_limit))
		{
			$("#Redeem_points").val("");
			$("#OnSubmit_error").html("You Canot Redeem <?php echo $Company_details->Currency_name; ?> More Than Redemption Limit, Merchant Redemption Limit is : "+Seller_redemption_limit+" <?php echo $Company_details->Currency_name; ?> ");
