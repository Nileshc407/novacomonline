                    ...
                    <div class="element-box">
                        ...
                        <div class="form-group">
						 ...
						 <div class="form-group">
                            ...
                            <select class="form-control" name="Payment_type" id="Payment_type" data-error="Select Payment by" required >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="remark" class="form-control" placeholder="Enter Payment Remarks"/>
                        </div>
