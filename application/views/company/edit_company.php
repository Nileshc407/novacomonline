					...
					<!-- sandeep gift card 10-05-2020 -->
									...
									<div class="form-group">
									 ...
									 <div class="col-sm-8" style=" margin-top:7px;">
										  <div class="form-check" >
											<label class="form-check-label">
											<input type="radio" class="form-check-input" name="Points_as_discount_flag" value="1"  <?php if($record->Points_as_discount_flag == 1){echo "checked";} ?>>Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<label class="form-check-label">
											<input type="radio" class="form-check-input" name="Points_as_discount_flag" value="0"  <?php if($record->Points_as_discount_flag == 0){echo "checked";} ?>>No</label>
										  </div> 
									 </div>
								    </div>
									<div class="form-group">
									...
									<div class="form-group">
									 <label for="">Enable Member Based Earning</label>
									 <div class="col-sm-8" style=" margin-top:7px;">
										  <div class="form-check" style="float:left;">
											<label class="form-check-label">
											<input type="radio" class="form-check-input" name="Member_based_earning_flag" value="1" onclick="toggle_Member_based_earning(this.value);" <?php if($record->Member_based_earning_flag == 1){echo "checked";} ?> >Yes</label>
										  </div>
										  
										  <div class="form-check" style="margin-left:50px;">
											<label class="form-check-label">
											<input type="radio" class="form-check-input" name="Member_based_earning_flag" value="0" <?php if($record->Member_based_earning_flag == 0){echo "checked";} ?> onclick="toggle_Member_based_earning(this.value);">No</label>
										  </div> 
									 </div>
								    </div>
									
									 <div class="form-group">
										<label for="">Time to Pick Transaction</label>
										<div class="row">
											<div class="col-md-4 text-center" style="margin: 10px auto;">
												<label for="exampleInputEmail1">Hour</label>
												<select class="form-control" name="THH" id="THH"  >
													<option value="">HH</option>
													<?php
													$Trans_time = explode(":", $record->Minutes_to_pick_temp_trans);
											...
											<div class="col-md-4 text-center" style="margin: 10px auto;">
												...
												<select class="form-control" name="TMM" id="TMM"  >
											...
											<div class="col-md-4 text-center" style="margin: 10px auto;">
												...
												<select class="form-control" name="TSS" id="TSS"  >
										...
										<div class="form-group">
										<label for="exampleInputEmail1">Purge Transaction in Days</label>
										<input type="text" name="Days_to_purge_temp_trans" id="Days_to_purge_temp_trans" class="form-control" placeholder="Enter Purge Transaction in Days" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter Purge Transaction in Days" value="<?php echo $record->Days_to_purge_temp_trans;?>">
										<div class="help-block form-text with-errors form-control-feedback"></div>
									</div>
