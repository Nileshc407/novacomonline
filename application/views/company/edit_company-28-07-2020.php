							...
							<!---------------Nilesh 8-7-2020- Dpo credit card-------------->
							  ...
							  <div class="form-group">
								...
								<?php } ?>
									...
									<?php } ?> 
									<div class="form-group">
									 <label for="">Beneficiary Point Transfer Module</label>
									 <div class="col-sm-8" style=" margin-top:7px;">
									  <div class="form-check" style="float:left;">
										<label class="form-check-label">
									...
									<div class="form-group" id="beneficiary_company_div">
										...
										<select class="form-control select2" id="beneficiary_company" name="Beneficiary_company[]" multiple="true" data-error="Please select beneficiary company" style="width:470px;" required="required">
										<?php	
