					...
					<!-- sandeep gift card 10-05-2020 -->
									...
									<div class="form-group">
									 ...
									 <div class="col-sm-8" style=" margin-top:7px;">
										  <div class="form-check" style="float:left;">
											<label class="form-check-label">
											<input type="radio" class="form-check-input" name="Member_based_earning_flag" value="1" onclick="toggle_Member_based_earning(this.value);">Yes</label>
										  </div>
										  
										  <div class="form-check" style="margin-left:50px;">
											<label class="form-check-label">
											<input type="radio" class="form-check-input" name="Member_based_earning_flag" value="0" checked onclick="toggle_Member_based_earning(this.value);">No</label>
										  </div> 
									 </div>
								    </div>
									 ...
									 <div class="form-group">
										...
										<input type="text" name="Days_to_purge_temp_trans" id="Days_to_purge_temp_trans" class="form-control" placeholder="Enter Purge Transaction in Days" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter Purge Transaction in Days">
										<div class="help-block form-text with-errors form-control-feedback"></div>
									</div>
								  </fieldset>  
