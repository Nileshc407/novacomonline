			...
			<?php $attributes = array('id' => 'formValidate');
				...
				<?php 	} ?>
							...
							<fieldset class="form-group">
								<legend><span>Upload Images of Voucher  <font color="RED" align="center" size="0.8em"><i>&nbsp;&nbsp;&nbsp;&nbsp;Image Resolution should be above 800(Horizontal) X 800(Vertical)  for best product view, File Size to be less than 100 KB</i></font></span></legend>
								<div class="row">
										...
										<div class="thumbnail">
											...
											<div class="caption">
												<div class="form-group upload-btn-wrapper">
													...
													<div class="help-block form-text with-errors form-control-feedback"></div>
													<div class="help-block11" style="float: center;"></div>
												</div>
		...
		var file = fileInput.files[0];
		 if (file) {
			...
			if (fileSize <= 102400) {
			  ...
			  var msg1 = 'File size exceeds the limit.';
				$('.help-block11').show();
				$('.help-block11').css("color","red");
