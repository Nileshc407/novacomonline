...
//******** Nilesh 8-7-2020 Provision for DPO Credit Card Payment URLs, KEY etc***********************
	...
	//********* gift card 10-05-2020 *********
		...
		//-------------------------AMIT PURGE TRANS-------------------------------
		$data['Member_based_earning_flag'] = $this->input->post('Member_based_earning_flag');
		$data['Days_to_purge_temp_trans'] = $this->input->post('Days_to_purge_temp_trans');
		$data['Minutes_to_pick_temp_trans'] = $this->input->post('THH').":".$this->input->post('TMM').":".$this->input->post('TSS');		
		//-------------------------------------------------------------
