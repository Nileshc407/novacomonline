...
{	
	...
	public function update_customer_earn_code($Customer_code,$Company_id,$cardId,$CustomerCodeData)
	{
		$this->db->where(array('Company_id' => $Company_id, 'Card_id' => $cardId, 'Pin' => $Customer_code));
		$this->db->update("igain_cust_earn_redeem_code_log", $CustomerCodeData);
