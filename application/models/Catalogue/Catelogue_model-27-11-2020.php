...
class Catelogue_model extends CI_Model
 {
	...
	{
		$this->db->select('A.Merchandize_category_id,A.Parent_category_id,A.Merchandize_category_name,A.Seller_id,CONCAT(First_name," ",Last_name) as Full_name,A.Category_order');
