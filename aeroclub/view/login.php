...
<?php
    ...
    <div class="container">
        <div class="card card-container" style="padding: 5px 40px;background-color:#F2F2F2; color: #2f296d;">	
            <img id="profile-img" class="profile-img-card" src="<?php echo $this->config->item('base_url2')?>images/aeroclub/logo.png" />			
			...
			<p style="color: #2f296d;font-size:12px;">Sign with your user email address and password</p>			
			<?php 
			...
			<?php echo form_close(); ?>
			<p>Are you a Member? <a href="#lost" data-dismiss="modal" data-toggle="modal" data-target="#myModal3" style="color:#2f296d;text-decoration: underline;">Sign up</a>
			</p>
				...
				<div class="modal-content">
					...
					<div class="modal-body modal-body-sub_agile">
						<div class="col-md-12 modal_body_left modal_body_left1">
							 <img id="profile-img" class="profile-img-card" src="<?php echo $this->config->item('base_url2')?>images/aeroclub/logo.png" style="width:40%"/>	
...
<!-- //Modal3 -->
		...
		<a href="#myModal14" data-toggle="modal" data-target="#myModal14" class="forgot-password success" style="color:#2f296d!IMPORTANT;">Forgot password?</a>		
		...
		<div id="myModal14" class="modal fade" role="dialog" >
					<div class="modal-dialog">
						...
						<div class="modal-content" style="background-color: #F2F2F2!IMPORTANT;">
						  ...
						  <div class="modal-header">
							<h4 class="modal-title" style="color:#2f296d;text-align:center">Forgot Password</h4>
						  </div>
...
body {
 ...
 background-image: url("<?php echo $this->config->item('base_url2')?>images/aeroclub/aeroclub.png"); 
	<?php }else{ ?>
 background-image: url("<?php echo $this->config->item('base_url2')?>images/aeroclub/aeroclub.png"); 
 <?php } ?>
